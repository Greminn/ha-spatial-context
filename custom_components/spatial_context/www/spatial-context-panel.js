...
`;function Zt(t,e,i,n){return t.map(t=>({pin:t,d:Ct(t.x,t.y,e,i)})).filter(({d:t})=>t<=n).sort((t,e)=>t.d-e.d).map(({pin:t})=>t)}function Jt(t,e,i,n){let s=null,o=n;return t.forEach(([t,n],r)=>{const l=Ct(t,n,e,i);l<=o&&(s=r,o=l)}),s}function Qt(t,e,i,n){let s=null,o=n;for(const n of t){const t=At(e,i,n.points);t<=o&&(s=n,o=t)}return s}function te(t,e,i,n){if(t.points.length>=3){const[s,o]=t.points[0];if(Ct(s,o,e,i)<=n)return{trace:t,closed:!0}}return{trace:{points:[...t.points,[e,i]]},closed:!1}}const ee=new Map;const ie=1e3,ne=750,se=14,oe="#03a9f4";let re=class extends ct{constructor(){super(...arguments),this.rooms=[],this.pins=[],this.walls=[],this.openings=[],this.scale=null,this.unitSystem="metric",this.meshLinks=[],this.meshStubs=[],this.entityLookup=new Map,this.backgroundImageUrl=null,this.backgroundOpacity=.5,this.backgroundOffsetX=0,this.backgroundOffsetY=0,this.backgroundScale=1,this.alignOverlay=null,this.initialViewBox=null,this.sameBuildingAsPrevious=!1,this.mode="select",this.armedEntityId=null,this.armedOpeningType=null,this.selectedRoomId=null,this.editingRoomId=null,this.editingWallId=null,this.selectedPinId=null,this.selectedWallId=null,this.selectedOpeningId=null,this.selectedMeshLinkKey=null,this.selectedMeshStubKey=null,this._viewBox={x:0,y:0,w:ie,h:ne},this._naturalHeight=ne,this._alignNaturalHeight=ne,this._pendingTrace=null,this._hoverSnap=null,this._pendingScalePoints=[],this._liveEditPoints=null,this._liveDragPin=null,this._liveOpeningEdit=null,this._selectedVertexIndex=null,this._pointers=new Map,this._downHit=null,this._downClient=null,this._lastImage=null,this._lastClient=null,this._gesture=null,this._moved=!1,this._hasFittedOnce=!1,this._onPointerDown=t=>{if("mouse"===t.pointerType&&0!==t.button)return;if(this._svg.setPointerCapture(t.pointerId),this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n={x:(e.x+i.x)/2,y:(e.y+i.y)/2};return void(this._gesture={kind:"pinch",startDistance:Ct(e.x,e.y,i.x,i.y),startViewBox:{...this._viewBox},midImage:this._clientToImage(n.x,n.y)})}if(this._pointers.size>2)return;const e=this._clientToImage(t.clientX,t.clientY);this._downClient={x:t.clientX,y:t.clientY},this._lastImage=e,this._lastClient={x:t.clientX,y:t.clientY},this._moved=!1,this._gesture=null,this._downHit="select"===this.mode?this._hitTest(t.clientX,t.clientY,e):{type:"empty"}},this._onPointerMove=t=>{if(!this._pointers.has(t.pointerId)){if("wall"===this.mode||"trace"===this.mode){const e=this._clientToImage(t.clientX,t.clientY);this._hoverSnap=this._snappedGeometryPoint(this._pendingTrace?.points??[],e.x,e.y,t.shiftKey)}else this._hoverSnap&&(this._hoverSnap=null);return}if(this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),"pinch"===this._gesture?.kind&&2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n=Ct(e.x,e.y,i.x,i.y)||1,s=this._gesture.startDistance/n,o=this._gesture.startViewBox,r=Tt(o.w*s,250,4e3),l=r/o.w,a=o.h*l,{x:c,y:d}=this._gesture.midImage;return void(this._viewBox={x:c-(c-o.x)*l,y:d-(d-o.y)*l,w:r,h:a})}if(1!==this._pointers.size||!this._downClient||!this._lastImage)return;if(!this._moved){if(Ct(this._downClient.x,this._downClient.y,t.clientX,t.clientY)<5)return;this._moved=!0,this._gesture=this._lockGesture(),"pan"!==this._gesture?.kind&&"alignDrag"!==this._gesture?.kind||(this._svg.style.cursor="grabbing")}const e=this._clientToImage(t.clientX,t.clientY);if("pan"===this._gesture?.kind){const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};this._viewBox={...this._viewBox,x:this._viewBox.x-(t.clientX-i.x)/e,y:this._viewBox.y-(t.clientY-i.y)/e}}else if("alignDrag"===this._gesture?.kind){const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};this.dispatchEvent(new CustomEvent("align-drag",{detail:{dx:(t.clientX-i.x)/e,dy:(t.clientY-i.y)/e}}))}else if("vertex"===this._gesture?.kind&&this._liveEditPoints){const i="room"===this._editingTarget?.kind,[n,s]=this._snappedVertexPoint(this._liveEditPoints,this._gesture.index,e.x,e.y,i,t.shiftKey),o=[...this._liveEditPoints];o[this._gesture.index]=[n,s],this._liveEditPoints=o}else if("pin"===this._gesture?.kind)this._liveDragPin={id:this._gesture.pinId,x:e.x,y:e.y};else if("openingMove"===this._gesture?.kind){const t=this._gesture,i=this.openings.find(e=>e.id===t.openingId),n=i&&this.walls.find(t=>t.id===i.wallId);if(i&&n){const t=this._effectivePoints("wall",n.id,n.points),{point:s}=Rt(t,e.x,e.y);this._liveOpeningEdit={id:i.id,x:s[0],y:s[1],width:i.width}}}else if("openingHandle"===this._gesture?.kind){const t=this._gesture,i=this.openings.find(e=>e.id===t.openingId),n=i&&this.walls.find(t=>t.id===i.wallId),s=i&&this._openingEndpoints(i);if(i&&n&&s){const o=this._effectivePoints("wall",n.id,n.points),{point:r}=Rt(o,e.x,e.y),l=s[0===t.whichEnd?1:0],a=[(l[0]+r[0])/2,(l[1]+r[1])/2],c=Ct(l[0],l[1],r[0],r[1]);this._liveOpeningEdit={id:i.id,x:a[0],y:a[1],width:c}}}this._lastImage=this._clientToImage(t.clientX,t.clientY),this._lastClient={x:t.clientX,y:t.clientY}},this._onPointerLeave=()=>{this._hoverSnap=null},this._onPointerUp=t=>{this._pointers.delete(t.pointerId),this._svg.style.cursor="";try{this._svg.releasePointerCapture(t.pointerId)}catch{}this._pointers.size>=1?this._gesture=null:(this._moved?this._commitGesture():this._downClient&&this._handleClick(this._downClient.x,this._downClient.y,t.shiftKey),this._gesture=null,this._downHit=null,this._downClient=null,this._moved=!1)},this._onWheel=t=>{if(t.preventDefault(),t.ctrlKey){const e=t.deltaY<0?.9:1.1;return void this._zoomBy(e,this._clientToImage(t.clientX,t.clientY))}const e=this._viewBox.w/this.getBoundingClientRect().width;this._viewBox={...this._viewBox,x:this._viewBox.x+t.deltaX*e,y:this._viewBox.y+t.deltaY*e}},this._resolvedIconOverrides=new Map,this._failedBrandIcons=new Set}get _editingTarget(){return this.editingRoomId?{kind:"room",id:this.editingRoomId}:this.editingWallId?{kind:"wall",id:this.editingWallId}:null}_rawPointsFor(t){return"room"===t.kind?this.rooms.find(e=>e.id===t.id)?.points??null:this.walls.find(e=>e.id===t.id)?.points??null}willUpdate(t){if(t.has("editingRoomId")||t.has("editingWallId")){const t=this._editingTarget,e=t?this._rawPointsFor(t):null;this._liveEditPoints=e?[...e]:null,this._selectedVertexIndex=null}t.has("mode")&&(this._pendingTrace=null,this._pendingScalePoints=[])}firstUpdated(){this.fitToScreen(),this._hasFittedOnce=null!==this._contentBounds()||!this.backgroundImageUrl,this._resizeObserver=new ResizeObserver(()=>this.requestUpdate()),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect()}updated(t){if(t.has("backgroundImageUrl")&&this.backgroundImageUrl){const t=new Image;t.onload=()=>{this._naturalHeight=t.naturalHeight/t.naturalWidth*ie||ne,this._hasFittedOnce||(this.fitToScreen(),this._hasFittedOnce=!0)},t.src=this.backgroundImageUrl}if(t.has("initialViewBox")&&(this.initialViewBox?(this._viewBox={...this.initialViewBox},this._hasFittedOnce=!0):this.sameBuildingAsPrevious||(this.fitToScreen(),this._hasFittedOnce=null!==this._contentBounds()||!this.backgroundImageUrl)),t.has("alignOverlay")){const e=t.get("alignOverlay");if(this.alignOverlay&&this.alignOverlay.imageUrl!==e?.imageUrl){const t=new Image;t.onload=()=>{this._alignNaturalHeight=t.naturalHeight/t.naturalWidth*ie||ne},t.src=this.alignOverlay.imageUrl}}if(t.has("_pendingTrace")||t.has("_pendingScalePoints")){const t="scale"===this.mode?this._pendingScalePoints.length:this._pendingTrace?.points.length??0;this.dispatchEvent(new CustomEvent("pending-changed",{detail:{count:t}}))}}_contentBounds(){const t=[];for(const e of this.rooms)t.push(...e.points);for(const e of this.walls)t.push(...e.points);for(const e of this.pins)t.push([e.x,e.y]);if(0===t.length)return null;const e=t.map(([t])=>t),i=t.map(([,t])=>t),n=Math.min(...e),s=Math.max(...e),o=Math.min(...i),r=Math.max(...i),l=.08*Math.max(s-n,r-o)||40;return{x:n-l,y:o-l,w:s-n+2*l,h:r-o+2*l}}fitToScreen(){this._viewBox=this._contentBounds()??{x:0,y:0,w:ie,h:this._naturalHeight}}getViewBox(){return{...this._viewBox}}_svgTransform(){const t=this._svg?.getBoundingClientRect(),e=t?.width||this._viewBox.w,i=t?.height||this._viewBox.h,n=Math.min(e/this._viewBox.w,i/this._viewBox.h)||1;return{scale:n,offsetX:(e-this._viewBox.w*n)/2,offsetY:(i-this._viewBox.h*n)/2}}_pxToUnits(t){return t/this._svgTransform().scale}_clientToImage(t,e){const i=this._svg,n=i.createSVGPoint();n.x=t,n.y=e;const s=i.getScreenCTM();if(!s)return{x:0,y:0};const o=n.matrixTransform(s.inverse());return{x:o.x,y:o.y}}_effectivePoints(t,e,i){const n=this._editingTarget;return n&&n.kind===t&&n.id===e&&this._liveEditPoints?this._liveEditPoints:i}_snappedTracePoint(t,e,i,n){if(n||0===t.length)return{point:[e,i],lockedX:!1,lockedY:!1};const s=this._pxToUnits(10),o=t[t.length-1],r=t[0],l=t.length>=3&&(r[0]!==o[0]||r[1]!==o[1])?[o,r]:[o];let a=null,c=1/0,d=null,h=1/0;for(const[t,n]of l){const o=Math.abs(e-t),r=Math.abs(i-n);o>s&&r>s||(o<=r?o<c&&(a=t,c=o):r<h&&(d=n,h=r))}return{point:[a??e,d??i],lockedX:null!==a,lockedY:null!==d}}_snappedVertexPoint(t,e,i,n,s,o){if(o)return[i,n];const r=this._pxToUnits(10),l=e>0?e-1:s?t.length-1:-1;if(l>=0&&l!==e)return zt(t[l],[i,n],r);const a=e<t.length-1?e+1:s?0:-1;return a>=0&&a!==e?zt(t[a],[i,n],r):[i,n]}_effectiveOpening(t){return this._liveOpeningEdit?.id===t.id?{...t,x:this._liveOpeningEdit.x,y:this._liveOpeningEdit.y,width:this._liveOpeningEdit.width}:t}_openingEndpoints(t){const e=this.walls.find(e=>e.id===t.wallId);if(!e)return null;const i=this._effectivePoints("wall",e.id,e.points),n=this._effectiveOpening(t);return Wt(n.x,n.y,n.width,i)}_snappedGeometryPoint(t,e,i,n){if(!n){const t=this._pxToUnits(se);let n=null;for(const s of this.walls){const o=parseFloat(this._wallStrokeWidth(s,$t(s.material)))/2,r=Math.max(t,o);if(At(e,i,s.points)>r)continue;const l=Rt(s.points,e,i).point,a=Ct(e,i,l[0],l[1]);(!n||a<n.dist)&&(n={point:l,dist:a})}const s=function(t,e,i,n){let s=null,o=n;for(const n of t){if(n.points.length<2)continue;const{point:t}=Dt(n.points,e,i),r=Ct(e,i,t[0],t[1]);r<=o&&(s=n,o=r)}return s}(this.rooms,e,i,t);if(s){const t=Dt(s.points,e,i).point,o=Ct(e,i,t[0],t[1]);(!n||o<n.dist)&&(n={point:t,dist:o})}if(n)return{point:n.point,kind:"geometry",lockedX:!1,lockedY:!1}}const{point:s,lockedX:o,lockedY:r}=this._snappedTracePoint(t,e,i,n);return{point:s,kind:o||r?"axis":"none",lockedX:o,lockedY:r}}_hitTest(t,e,i){const n=this._pxToUnits(se);if("select"!==this.mode)return{type:"empty"};const s=this._editingTarget;if(s&&this._liveEditPoints){const t=this._liveEditPoints,e=Jt(t,i.x,i.y,n);if(null!==e)return{type:"vertex",index:e};const o=Jt("room"===s.kind?Lt(t):Ft(t),i.x,i.y,n);return null!==o?{type:"edgeMidpoint",index:o}:{type:"empty"}}const o=Zt(this.pins,i.x,i.y,n);if(o.length>1)return{type:"pinStack",pins:o};if(1===o.length)return{type:"pin",pin:o[0]};const r=function(t,e,i,n){let s=null,o=n;for(const n of t){const t=At(e,i,[[n.fromPin.x,n.fromPin.y],[n.toPin.x,n.toPin.y]]);t<=o&&(s=n,o=t)}return s}(this.meshLinks,i.x,i.y,n);if(r)return{type:"meshLink",link:r};const l=function(t,e,i,n){let s=null,o=n;for(const n of t){const t=Math.min(Ct(n.x,n.y,e,i),At(e,i,[[n.fromPin.x,n.fromPin.y],[n.x,n.y]]));t<=o&&(s=n,o=t)}return s}(this.meshStubs,i.x,i.y,n);if(l)return{type:"meshStub",stub:l};if(this.selectedOpeningId){const t=this.openings.find(t=>t.id===this.selectedOpeningId),e=t?this._openingEndpoints(t):null;if(t&&e){const s=Jt(e,i.x,i.y,n);if(null!==s)return{type:"openingHandle",opening:t,whichEnd:s}}}const a=function(t,e,i,n,s){let o=null,r=s;for(const s of t){const t=e.find(t=>t.id===s.wallId);if(!t)continue;const l=Wt(s.x,s.y,s.width,t.points);if(!l)continue;const a=At(i,n,l);a<=r&&(o=s,r=a)}return o}(this.openings,this.walls,i.x,i.y,n);if(a)return{type:"opening",opening:a};const c=Qt(this.walls,i.x,i.y,n);if(c)return{type:"wall",wall:c};const d=this.rooms.find(t=>t.points.length>=3&&Et(i.x,i.y,t.points));return d?{type:"room",room:d}:{type:"empty"}}_lockGesture(){return"align"===this.mode?{kind:"alignDrag"}:"vertex"===this._downHit?.type?{kind:"vertex",index:this._downHit.index}:"pin"===this._downHit?.type?{kind:"pin",pinId:this._downHit.pin.id}:"openingHandle"===this._downHit?.type?{kind:"openingHandle",openingId:this._downHit.opening.id,whichEnd:this._downHit.whichEnd}:"opening"===this._downHit?.type?{kind:"openingMove",openingId:this._downHit.opening.id}:{kind:"pan"}}_dispatchVertexChanged(t){const e=this._editingTarget;if(!e)return;const i="room"===e.kind?"room-vertex-changed":"wall-vertex-changed",n="room"===e.kind?"roomId":"wallId";this.dispatchEvent(new CustomEvent(i,{detail:{[n]:e.id,points:t}}))}_commitGesture(){"vertex"===this._gesture?.kind&&this._editingTarget&&this._liveEditPoints?this._dispatchVertexChanged(this._liveEditPoints):"pin"===this._gesture?.kind&&this._liveDragPin?(this.dispatchEvent(new CustomEvent("pin-move",{detail:{pinId:this._liveDragPin.id,x:this._liveDragPin.x,y:this._liveDragPin.y}})),this._liveDragPin=null):"openingMove"!==this._gesture?.kind&&"openingHandle"!==this._gesture?.kind||!this._liveOpeningEdit||(this.dispatchEvent(new CustomEvent("opening-update",{detail:{openingId:this._liveOpeningEdit.id,x:this._liveOpeningEdit.x,y:this._liveOpeningEdit.y,width:this._liveOpeningEdit.width}})),this._liveOpeningEdit=null)}_handleClick(t,e,i=!1){const n=this._clientToImage(t,e);if("trace"===this.mode){const t=this._pxToUnits(se),e=this._pendingTrace??{points:[]},{point:[s,o]}=this._snappedGeometryPoint(e.points,n.x,n.y,i),r=te(e,s,o,t);return void(r.closed?(this.dispatchEvent(new CustomEvent("room-trace-complete",{detail:{points:e.points}})),this._pendingTrace=null):this._pendingTrace=r.trace)}if("wall"===this.mode){const t=this._pxToUnits(se),e=this._pendingTrace??{points:[]},{point:[s,o]}=this._snappedGeometryPoint(e.points,n.x,n.y,i),r=te(e,s,o,t);return void(r.closed?(this.dispatchEvent(new CustomEvent("wall-trace-complete",{detail:{points:[...e.points,e.points[0]]}})),this._pendingTrace=null):this._pendingTrace=r.trace)}if("opening"===this.mode){if(!this.armedOpeningType)return;const t=this._pxToUnits(se),e=Qt(this.walls,n.x,n.y,t);if(!e)return;const{point:i}=Rt(e.points,n.x,n.y);return void this.dispatchEvent(new CustomEvent("opening-place",{detail:{wallId:e.id,x:i[0],y:i[1]}}))}if("scale"===this.mode){const t=[...this._pendingScalePoints,[n.x,n.y]];return void(t.length>=2?(this.dispatchEvent(new CustomEvent("scale-line-complete",{detail:{points:t.slice(0,2)}})),this._pendingScalePoints=[]):this._pendingScalePoints=t)}if("place"===this.mode){if(this.armedEntityId){const t=this._pxToUnits(se),e=Zt(this.pins,n.x,n.y,t)[0],i=e?.x??n.x,s=e?.y??n.y;this.dispatchEvent(new CustomEvent("pin-place",{detail:{x:i,y:s}}))}return}const s=this._downHit??{type:"empty"};if("vertex"===s.type)this._selectedVertexIndex=this._selectedVertexIndex===s.index?null:s.index;else if("edgeMidpoint"===s.type&&this._editingTarget&&this._liveEditPoints){const t=("room"===this._editingTarget.kind?Lt(this._liveEditPoints):Ft(this._liveEditPoints))[s.index],e=[...this._liveEditPoints];e.splice(s.index+1,0,t),this._liveEditPoints=e,this._dispatchVertexChanged(e)}else if("pin"===s.type)this.dispatchEvent(new CustomEvent("pin-select",{detail:{pinId:this.selectedPinId===s.pin.id?null:s.pin.id}}));else if("pinStack"===s.type)this.dispatchEvent(new CustomEvent("pin-stack-select",{detail:{pinIds:s.pins.map(t=>t.id)}}));else if("room"===s.type)this.dispatchEvent(new CustomEvent("room-select",{detail:{roomId:this.selectedRoomId===s.room.id?null:s.room.id}}));else if("wall"===s.type)this.dispatchEvent(new CustomEvent("wall-select",{detail:{wallId:this.selectedWallId===s.wall.id?null:s.wall.id}}));else if("opening"===s.type)this.dispatchEvent(new CustomEvent("opening-select",{detail:{openingId:this.selectedOpeningId===s.opening.id?null:s.opening.id}}));else if("meshLink"===s.type){const t=`${s.link.fromPin.id}|${s.link.toPin.id}`;this.dispatchEvent(new CustomEvent("mesh-link-select",{detail:{link:this.selectedMeshLinkKey===t?null:s.link}}))}else if("meshStub"===s.type){const t=`${s.stub.fromPin.id}|${s.stub.targetDeviceId}`;this.dispatchEvent(new CustomEvent("mesh-stub-select",{detail:{stub:this.selectedMeshStubKey===t?null:s.stub}}))}else if(this._editingTarget&&null!==this._selectedVertexIndex&&this._liveEditPoints){const t="room"===this._editingTarget.kind,[e,s]=this._snappedVertexPoint(this._liveEditPoints,this._selectedVertexIndex,n.x,n.y,t,i),o=[...this._liveEditPoints];o[this._selectedVertexIndex]=[e,s],this._liveEditPoints=o,this._selectedVertexIndex=null,this._dispatchVertexChanged(o)}else this._selectedVertexIndex=null,this.dispatchEvent(new CustomEvent("room-select",{detail:{roomId:null}})),this.dispatchEvent(new CustomEvent("pin-select",{detail:{pinId:null}})),this.dispatchEvent(new CustomEvent("wall-select",{detail:{wallId:null}})),this.dispatchEvent(new CustomEvent("opening-select",{detail:{openingId:null}})),this.dispatchEvent(new CustomEvent("mesh-link-select",{detail:{link:null}})),this.dispatchEvent(new CustomEvent("mesh-stub-select",{detail:{stub:null}}))}finishPendingWall(){"wall"!==this.mode||!this._pendingTrace||this._pendingTrace.points.length<2||(this.dispatchEvent(new CustomEvent("wall-trace-complete",{detail:{points:this._pendingTrace.points}})),this._pendingTrace=null)}cancelPending(){this._pendingTrace=null,this._pendingScalePoints=[]}_deleteSelectedVertex(){const t=this._editingTarget;if(null===this._selectedVertexIndex||!t||!this._liveEditPoints)return;const e="room"===t.kind?3:2;if(this._liveEditPoints.length<=e)return;const i=this._liveEditPoints.filter((t,e)=>e!==this._selectedVertexIndex);this._liveEditPoints=i,this._selectedVertexIndex=null,this._dispatchVertexChanged(i)}_zoomBy(t,e){const i=Tt(this._viewBox.w*t,250,4e3),n=i/this._viewBox.w,s=this._viewBox.h*n;this._viewBox={x:e.x-(e.x-this._viewBox.x)*n,y:e.y-(e.y-this._viewBox.y)*n,w:i,h:s}}_zoomButton(t){const e=this._viewBox;this._zoomBy(t,{x:e.x+e.w/2,y:e.y+e.h/2})}_pinLabel(t){return t.label_override?t.label_override:bt(t.device_id,this.entityLookup.values())}_renderRoom(t){if(!1===t.visible)return j;const e=this._effectivePoints("room",t.id,t.points);if(e.length<2)return j;const i=e.map(([t,e])=>`${t},${e}`).join(" "),[n,s]=function(t){if(0===t.length)return[0,0];let e=0,i=0;for(const[n,s]of t)e+=n,i+=s;return[e/t.length,i/t.length]}(e),o=this.editingRoomId===t.id,r=t.id===this.selectedRoomId||o,l=t.fill_color??oe,a=t.fill_opacity??.18,c=t.border_opacity??1;return X`
    ...
    `}_renderVertexHandles(t,e){const i=this._pxToUnits(6),n=this._pxToUnits(4),s=e?Lt(t):Ft(t);return X`
    ...
    `}_renderPendingTrace(){const t=this._pendingTrace?.points??[];if(0===t.length&&!this._hoverSnap)return j;const e=t.map(([t,e])=>`${t},${e}`).join(" "),i=this._pxToUnits(6),n=t[t.length-1],s=t[0],o=!!this._hoverSnap&&!!s&&t.length>=3&&Ct(this._hoverSnap.point[0],this._hoverSnap.point[1],s[0],s[1])<=this._pxToUnits(se);return X`
    ...
    `}_renderScaleLine(){if(!this.scale)return j;const[[t,e],[i,n]]=this.scale.points;return X`
      ...
      <text class="scale-label" x=${(t+i)/2} y=${(e+n)/2-6}>
        ${Vt(this.scale.meters,this.unitSystem)}
        ${Nt(this.unitSystem)}
      </text>
    `}_renderPendingScale(){if(0===this._pendingScalePoints.length)return j;const t=this._pxToUnits(6),[e,i]=this._pendingScalePoints[0];return X`<circle class="vertex-handle" cx=${e} cy=${i} r=${t}></circle>`}_renderBackgroundOverlay(){if(!this.backgroundImageUrl)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.backgroundOffsetX-this._viewBox.x),s=i+t*(this.backgroundOffsetY-this._viewBox.y),o=t*this.backgroundScale;return V`
      ...
      >
        <img
          ...
          style="width:${ie}px; height:${this._naturalHeight}px; opacity:${this.backgroundOpacity};"
        />
      </div>
    `}_renderAlignOverlay(){if(!this.alignOverlay)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.alignOverlay.offsetX-this._viewBox.x),s=i+t*(this.alignOverlay.offsetY-this._viewBox.y),o=t*this.alignOverlay.scale;return V`
      ...
      >
        <img
          ...
          style="width:${ie}px; height:${this._alignNaturalHeight}px; opacity:${this.alignOverlay.opacity};"
        />
      </div>
    ...
    `],t([_t({attribute:!1})],ae.prototype,"placements",void 0),t([_t({attribute:!1})],ae.prototype,"floorNameById",void 0),t([_t({attribute:!1})],ae.prototype,"floorIconById",void 0),t([_t({attribute:!1})],ae.prototype,"backgroundImageUrl",void 0),t([_t({type:Number})],ae.prototype,"backgroundOpacity",void 0),t([_t({type:Number})],ae.prototype,"backgroundOffsetX",void 0),t([_t({type:Number})],ae.prototype,"backgroundOffsetY",void 0),t([_t({type:Number})],ae.prototype,"backgroundScale",void 0),t([_t({attribute:!1})],ae.prototype,"mode",void 0),t([_t({attribute:!1})],ae.prototype,"selectedPlacementId",void 0),t([_t({attribute:!1})],ae.prototype,"initialViewBox",void 0),t([gt()],ae.prototype,"_viewBox",void 0),t([gt()],ae.prototype,"_naturalHeight",void 0),t([mt("svg")],ae.prototype,"_svg",void 0),ae=t([ht("property-canvas")],ae);const ce={en:{floorTabs:{property:"Property"},appHeader:{subtitle:"Floor plan & device mapping",saving:"Saving…",save:"Save"}},de:{floorTabs:{property:"Anwesen"},appHeader:{subtitle:"Grundriss und Geräteplatzierung",saving:"Speichert…",save:"Speichern"}}};function de(t,e){let i=t;for(const t of e.split(".")){if("object"!=typeof i||null===i)return;i=i[t]}return"string"==typeof i?i:void 0}function he(t,e){return de(ce.en,t)??de(ce.en,t)??t}let pe=class extends ct{constructor(){super(...arguments),this.floors=[],this.selectedFloorId=null,this.propertySelected=!1}render(){return V`
      ${this.floors.map(t=>V`
          <button
      ...
      >
        ...
        <span>${he("floorTabs.property")}</span>
      </button>
    `}};pe.styles=[Gt,r`
      :host {
        display: flex;
    ...
    `],t([_t({attribute:!1})],pe.prototype,"floors",void 0),t([_t({attribute:!1})],pe.prototype,"selectedFloorId",void 0),t([_t({type:Boolean})],pe.prototype,"propertySelected",void 0),pe=t([ht("floor-tabs")],pe);let ue=class extends ct{constructor(){super(...arguments),this.floors=[],this.selectedFloorId=null,this.propertySelected=!1,this.dirty=!1,this.saving=!1}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}render(){return V`
      <div class="identity">
        <img class="app-icon" src="/spatial_context/icon.png" alt="" />
        <div>
          <h1>Spatial Context</h1>
          <div class="subtitle">
            v0.6.0-beta.1 · ${he("appHeader.subtitle")}
          </div>
        </div>
      </div>
      <floor-tabs
      ...
      <div class="actions">
        ...
        <button
          class="icon-button"
          title=${this.saving?he("appHeader.saving"):he("appHeader.save")}
    ...
    `}_renderHintBar(){return"trace"===this.mode&&this.hasPendingTrace?V`<div class="hint-bar floating-panel">
      ...
      `}if(this.selectedWall){const t=this.selectedWall,e=this._wallThicknessUnit??jt(this.unitSystem),i=this._thicknessInputAttrs(e);return V`
        <div class="selection-panel floating-panel">
          ...
          <input
            ...
            step=${i.step}
            .value=${Kt(wt(t),e)}
            @change=${t=>{const i=qt(t.target.value,e);null===i||!Number.isFinite(i)||i<=0||this._fire("wall-thickness-change",{thicknessCm:i})}}
          />
      ...
      `}if(this.selectedOpening){const t=this.selectedOpening,e=this._openingWidthUnit??jt(this.unitSystem),i=this._thicknessInputAttrs(e),n=this.unitsPerMeter;return V`
        <div class="selection-panel floating-panel">
          ...
          <input
            ...
            .value=${null!==n?function(t,e,i){return Kt(t/e*100,i)}(t.width,n,e):String(t.width)}
            @change=${t=>{const i=t.target.value,s=null!==n?function(t,e,i){const n=qt(t,i);return null===n?null:n/100*e}(i,n,e):Number(i);null===s||!Number.isFinite(s)||s<=0||this._fire("opening-width-change",{width:s})}}
          />
    ...
    `],t([_t({attribute:!1})],_e.prototype,"mode",void 0),t([_t({attribute:!1})],_e.prototype,"armedOpeningType",void 0),t([_t({type:Boolean})],_e.prototype,"hasPendingTrace",void 0),t([_t({type:Boolean})],_e.prototype,"hasPendingWall",void 0),t([_t({type:Number})],_e.prototype,"pendingScaleCount",void 0),t([_t({attribute:!1})],_e.prototype,"scaleReadout",void 0),t([_t({attribute:!1})],_e.prototype,"selectedRoom",void 0),t([_t({type:Boolean})],_e.prototype,"editingRoom",void 0),t([_t({attribute:!1})],_e.prototype,"areas",void 0),t([_t({attribute:!1})],_e.prototype,"selectedPin",void 0),t([_t({attribute:!1})],_e.prototype,"selectedWall",void 0),t([_t({type:Boolean})],_e.prototype,"editingWall",void 0),t([_t({attribute:!1})],_e.prototype,"unitSystem",void 0),t([_t({type:Number})],_e.prototype,"unitsPerMeter",void 0),t([_t({attribute:!1})],_e.prototype,"pinStack",void 0),t([_t({attribute:!1})],_e.prototype,"entityLookup",void 0),t([_t({attribute:!1})],_e.prototype,"selectedOpening",void 0),t([_t({attribute:!1})],_e.prototype,"selectedMeshLink",void 0),t([_t({attribute:!1})],_e.prototype,"selectedMeshStub",void 0),t([_t({attribute:!1})],_e.prototype,"otherFloors",void 0),t([_t({attribute:!1})],_e.prototype,"alignTargetFloorId",void 0),t([_t({type:Boolean})],_e.prototype,"alignTargetHasBackground",void 0),t([gt()],_e.prototype,"_wallThicknessUnit",void 0),t([gt()],_e.prototype,"_openingWidthUnit",void 0),_e=t([ht("canvas-overlay")],_e);let ge=class extends ct{constructor(){super(...arguments),this.icon="",this.label="",this.open=!1}render(){return V`
      <button
    ...
    `],ye.WIDTH_STORAGE_KEY="spatial-context.entityPickerSidebarWidth",ye.MIN_WIDTH=240,ye.MAX_WIDTH=600,t([_t({attribute:!1})],ye.prototype,"entities",void 0),t([_t({attribute:!1})],ye.prototype,"placedDeviceIds",void 0),t([_t({attribute:!1})],ye.prototype,"armedEntityId",void 0),t([_t({attribute:!1})],ye.prototype,"floors",void 0),t([_t({attribute:!1})],ye.prototype,"areas",void 0),t([_t({attribute:!1})],ye.prototype,"currentFloorId",void 0),t([gt()],ye.prototype,"_search",void 0),t([gt()],ye.prototype,"_floorFilter",void 0),t([gt()],ye.prototype,"_areaFilter",void 0),ye=me=t([ht("entity-picker-sidebar")],ye);let ve=class extends ct{constructor(){super(...arguments),this.mode="select",this.buildings=[],this.armedBuildingKey=null,this.selectedPlacement=null,this.floorNameById=new Map}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_selectedLabel(){const t=this.selectedPlacement;return t?t.label_override||this.floorNameById.get(t.floor_id)||t.floor_id:""}render(){return V`
      <div class="mode-toolbar floating-panel">
        <button
    ...
    `],be._ACCEPTED_BACKGROUND_TYPES=new Set(["image/png","image/jpeg","image/gif"]),t([gt()],be.prototype,"_floors",void 0),t([gt()],be.prototype,"_currentFloorId",void 0),t([gt()],be.prototype,"_layout",void 0),t([gt()],be.prototype,"_entities",void 0),t([gt()],be.prototype,"_areas",void 0),t([gt()],be.prototype,"_mode",void 0),t([gt()],be.prototype,"_dragOverCanvas",void 0),t([gt()],be.prototype,"_armedEntityId",void 0),t([gt()],be.prototype,"_armedOpeningType",void 0),t([gt()],be.prototype,"_selectedRoomId",void 0),t([gt()],be.prototype,"_editingRoomId",void 0),t([gt()],be.prototype,"_selectedPinId",void 0),t([gt()],be.prototype,"_pinStackIds",void 0),t([gt()],be.prototype,"_selectedWallId",void 0),t([gt()],be.prototype,"_editingWallId",void 0),t([gt()],be.prototype,"_selectedOpeningId",void 0),t([gt()],be.prototype,"_selectedMeshLink",void 0),t([gt()],be.prototype,"_selectedMeshStub",void 0),t([gt()],be.prototype,"_otherFloorPinsByDeviceId",void 0),t([gt()],be.prototype,"_dirty",void 0),t([gt()],be.prototype,"_saving",void 0),t([gt()],be.prototype,"_loading",void 0),t([gt()],be.prototype,"_pendingCount",void 0),t([gt()],be.prototype,"_networkType",void 0),t([gt()],be.prototype,"_zigbeeMesh",void 0),t([gt()],be.prototype,"_zigbeeMeshLoading",void 0),t([gt()],be.prototype,"_zigbeeMeshError",void 0),t([gt()],be.prototype,"_zigbeeMeshFetchedAt",void 0),t([gt()],be.prototype,"_zigbeeMeshElapsedSeconds",void 0),t([gt()],be.prototype,"_wifiMesh",void 0),t([gt()],be.prototype,"_wifiMeshLoading",void 0),t([gt()],be.prototype,"_wifiMeshError",void 0),t([gt()],be.prototype,"_wifiMeshFetchedAt",void 0),t([gt()],be.prototype,"_matterTopology",void 0),t([gt()],be.prototype,"_matterError",void 0),t([gt()],be.prototype,"_backgroundPopoverOpen",void 0),t([gt()],be.prototype,"_meshPopoverOpen",void 0),t([gt()],be.prototype,"_settings",void 0),t([gt()],be.prototype,"_settingsPopoverOpen",void 0),t([gt()],be.prototype,"_moreOptionsPopoverOpen",void 0),t([gt()],be.prototype,"_view",void 0),t([gt()],be.prototype,"_propertyLayout",void 0),t([gt()],be.prototype,"_propertyDirty",void 0),t([gt()],be.prototype,"_propertySaving",void 0),t([gt()],be.prototype,"_selectedPlacementId",void 0),t([gt()],be.prototype,"_propertyMode",void 0),t([gt()],be.prototype,"_armedBuildingKey",void 0),t([gt()],be.prototype,"_sameBuildingAsPreviousFloor",void 0),t([gt()],be.prototype,"_alignTargetFloorId",void 0),t([gt()],be.prototype,"_alignTargetLayout",void 0),t([gt()],be.prototype,"_alignOffsetX",void 0),t([gt()],be.prototype,"_alignOffsetY",void 0),t([gt()],be.prototype,"_alignScale",void 0),t([mt("floorplan-canvas")],be.prototype,"_canvas",void 0),t([mt("property-canvas")],be.prototype,"_propertyCanvas",void 0),t([mt("#file-input")],be.prototype,"_fileInput",void 0),be=fe=t([ht("spatial-context-panel")],be)}();

...
`;function Kt(t,e,i,n){return t.map(t=>({pin:t,d:Mt(t.x,t.y,e,i)})).filter(({d:t})=>t<=n).sort((t,e)=>t.d-e.d).map(({pin:t})=>t)}function Gt(t,e,i,n){let s=null,o=n;return t.forEach(([t,n],l)=>{const r=Mt(t,n,e,i);r<=o&&(s=l,o=r)}),s}function Zt(t,e,i,n){let s=null,o=n;for(const n of t){const t=Bt(e,i,n.points);t<=o&&(s=n,o=t)}return s}function Jt(t,e,i,n){if(t.points.length>=3){const[s,o]=t.points[0];if(Mt(s,o,e,i)<=n)return{trace:t,closed:!0}}return{trace:{points:[...t.points,[e,i]]},closed:!1}}const Qt=new Map;const te=1e3,ee=750,ie=14;let ne=class extends dt{constructor(){super(...arguments),this.rooms=[],this.pins=[],this.walls=[],this.openings=[],this.scale=null,this.unitSystem="metric",this.meshLinks=[],this.meshStubs=[],this.entityLookup=new Map,this.backgroundImageUrl=null,this.backgroundOpacity=.5,this.backgroundOffsetX=0,this.backgroundOffsetY=0,this.backgroundScale=1,this.alignOverlay=null,this.initialViewBox=null,this.sameBuildingAsPrevious=!1,this.mode="select",this.armedEntityId=null,this.armedOpeningType=null,this.selectedRoomId=null,this.editingRoomId=null,this.editingWallId=null,this.selectedPinId=null,this.selectedWallId=null,this.selectedOpeningId=null,this.selectedMeshLinkKey=null,this.selectedMeshStubKey=null,this._viewBox={x:0,y:0,w:te,h:ee},this._naturalHeight=ee,this._alignNaturalHeight=ee,this._pendingTrace=null,this._pendingScalePoints=[],this._liveEditPoints=null,this._liveDragPin=null,this._liveOpeningEdit=null,this._selectedVertexIndex=null,this._pointers=new Map,this._downHit=null,this._downClient=null,this._lastImage=null,this._lastClient=null,this._gesture=null,this._moved=!1,this._hasFittedOnce=!1,this._onPointerDown=t=>{if("mouse"===t.pointerType&&0!==t.button)return;if(this._svg.setPointerCapture(t.pointerId),this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n={x:(e.x+i.x)/2,y:(e.y+i.y)/2};return void(this._gesture={kind:"pinch",startDistance:Mt(e.x,e.y,i.x,i.y),startViewBox:{...this._viewBox},midImage:this._clientToImage(n.x,n.y)})}if(this._pointers.size>2)return;const e=this._clientToImage(t.clientX,t.clientY);this._downClient={x:t.clientX,y:t.clientY},this._lastImage=e,this._lastClient={x:t.clientX,y:t.clientY},this._moved=!1,this._gesture=null,this._downHit="select"===this.mode?this._hitTest(t.clientX,t.clientY,e):{type:"empty"}},this._onPointerMove=t=>{if(!this._pointers.has(t.pointerId))return;if(this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),"pinch"===this._gesture?.kind&&2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n=Mt(e.x,e.y,i.x,i.y)||1,s=this._gesture.startDistance/n,o=this._gesture.startViewBox,l=Ct(o.w*s,250,4e3),r=l/o.w,a=o.h*r,{x:d,y:c}=this._gesture.midImage;return void(this._viewBox={x:d-(d-o.x)*r,y:c-(c-o.y)*r,w:l,h:a})}if(1!==this._pointers.size||!this._downClient||!this._lastImage)return;if(!this._moved){if(Mt(this._downClient.x,this._downClient.y,t.clientX,t.clientY)<5)return;this._moved=!0,this._gesture=this._lockGesture(),"pan"!==this._gesture?.kind&&"alignDrag"!==this._gesture?.kind||(this._svg.style.cursor="grabbing")}const e=this._clientToImage(t.clientX,t.clientY);if("pan"===this._gesture?.kind){const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};this._viewBox={...this._viewBox,x:this._viewBox.x-(t.clientX-i.x)/e,y:this._viewBox.y-(t.clientY-i.y)/e}}else if("alignDrag"===this._gesture?.kind){const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};this.dispatchEvent(new CustomEvent("align-drag",{detail:{dx:(t.clientX-i.x)/e,dy:(t.clientY-i.y)/e}}))}else if("vertex"===this._gesture?.kind&&this._liveEditPoints){const i="room"===this._editingTarget?.kind,[n,s]=this._snappedVertexPoint(this._liveEditPoints,this._gesture.index,e.x,e.y,i,t.shiftKey),o=[...this._liveEditPoints];o[this._gesture.index]=[n,s],this._liveEditPoints=o}else if("pin"===this._gesture?.kind)this._liveDragPin={id:this._gesture.pinId,x:e.x,y:e.y};else if("openingMove"===this._gesture?.kind){const t=this._gesture,i=this.openings.find(e=>e.id===t.openingId),n=i&&this.walls.find(t=>t.id===i.wallId);if(i&&n){const t=this._effectivePoints("wall",n.id,n.points),{point:s}=Ft(t,e.x,e.y);this._liveOpeningEdit={id:i.id,x:s[0],y:s[1],width:i.width}}}else if("openingHandle"===this._gesture?.kind){const t=this._gesture,i=this.openings.find(e=>e.id===t.openingId),n=i&&this.walls.find(t=>t.id===i.wallId),s=i&&this._openingEndpoints(i);if(i&&n&&s){const o=this._effectivePoints("wall",n.id,n.points),{point:l}=Ft(o,e.x,e.y),r=s[0===t.whichEnd?1:0],a=[(r[0]+l[0])/2,(r[1]+l[1])/2],d=Mt(r[0],r[1],l[0],l[1]);this._liveOpeningEdit={id:i.id,x:a[0],y:a[1],width:d}}}this._lastImage=this._clientToImage(t.clientX,t.clientY),this._lastClient={x:t.clientX,y:t.clientY}},this._onPointerUp=t=>{this._pointers.delete(t.pointerId),this._svg.style.cursor="";try{this._svg.releasePointerCapture(t.pointerId)}catch{}this._pointers.size>=1?this._gesture=null:(this._moved?this._commitGesture():this._downClient&&this._handleClick(this._downClient.x,this._downClient.y,t.shiftKey),this._gesture=null,this._downHit=null,this._downClient=null,this._moved=!1)},this._onWheel=t=>{if(t.preventDefault(),t.ctrlKey){const e=t.deltaY<0?.9:1.1;return void this._zoomBy(e,this._clientToImage(t.clientX,t.clientY))}const e=this._viewBox.w/this.getBoundingClientRect().width;this._viewBox={...this._viewBox,x:this._viewBox.x+t.deltaX*e,y:this._viewBox.y+t.deltaY*e}},this._resolvedIconOverrides=new Map,this._failedBrandIcons=new Set}get _editingTarget(){return this.editingRoomId?{kind:"room",id:this.editingRoomId}:this.editingWallId?{kind:"wall",id:this.editingWallId}:null}_rawPointsFor(t){return"room"===t.kind?this.rooms.find(e=>e.id===t.id)?.points??null:this.walls.find(e=>e.id===t.id)?.points??null}willUpdate(t){if(t.has("editingRoomId")||t.has("editingWallId")){const t=this._editingTarget,e=t?this._rawPointsFor(t):null;this._liveEditPoints=e?[...e]:null,this._selectedVertexIndex=null}t.has("mode")&&(this._pendingTrace=null,this._pendingScalePoints=[])}firstUpdated(){this.fitToScreen(),this._hasFittedOnce=null!==this._contentBounds()||!this.backgroundImageUrl,this._resizeObserver=new ResizeObserver(()=>this.requestUpdate()),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect()}updated(t){if(t.has("backgroundImageUrl")&&this.backgroundImageUrl){const t=new Image;t.onload=()=>{this._naturalHeight=t.naturalHeight/t.naturalWidth*te||ee,this._hasFittedOnce||(this.fitToScreen(),this._hasFittedOnce=!0)},t.src=this.backgroundImageUrl}if(t.has("initialViewBox")&&(this.initialViewBox?(this._viewBox={...this.initialViewBox},this._hasFittedOnce=!0):this.sameBuildingAsPrevious||(this.fitToScreen(),this._hasFittedOnce=null!==this._contentBounds()||!this.backgroundImageUrl)),t.has("alignOverlay")){const e=t.get("alignOverlay");if(this.alignOverlay&&this.alignOverlay.imageUrl!==e?.imageUrl){const t=new Image;t.onload=()=>{this._alignNaturalHeight=t.naturalHeight/t.naturalWidth*te||ee},t.src=this.alignOverlay.imageUrl}}if(t.has("_pendingTrace")||t.has("_pendingScalePoints")){const t="scale"===this.mode?this._pendingScalePoints.length:this._pendingTrace?.points.length??0;this.dispatchEvent(new CustomEvent("pending-changed",{detail:{count:t}}))}}_contentBounds(){const t=[];for(const e of this.rooms)t.push(...e.points);for(const e of this.walls)t.push(...e.points);for(const e of this.pins)t.push([e.x,e.y]);if(0===t.length)return null;const e=t.map(([t])=>t),i=t.map(([,t])=>t),n=Math.min(...e),s=Math.max(...e),o=Math.min(...i),l=Math.max(...i),r=.08*Math.max(s-n,l-o)||40;return{x:n-r,y:o-r,w:s-n+2*r,h:l-o+2*r}}fitToScreen(){this._viewBox=this._contentBounds()??{x:0,y:0,w:te,h:this._naturalHeight}}getViewBox(){return{...this._viewBox}}_svgTransform(){const t=this._svg?.getBoundingClientRect(),e=t?.width||this._viewBox.w,i=t?.height||this._viewBox.h,n=Math.min(e/this._viewBox.w,i/this._viewBox.h)||1;return{scale:n,offsetX:(e-this._viewBox.w*n)/2,offsetY:(i-this._viewBox.h*n)/2}}_pxToUnits(t){return t/this._svgTransform().scale}_clientToImage(t,e){const i=this._svg,n=i.createSVGPoint();n.x=t,n.y=e;const s=i.getScreenCTM();if(!s)return{x:0,y:0};const o=n.matrixTransform(s.inverse());return{x:o.x,y:o.y}}_effectivePoints(t,e,i){const n=this._editingTarget;return n&&n.kind===t&&n.id===e&&this._liveEditPoints?this._liveEditPoints:i}_snappedTracePoint(t,e,i,n){if(n||0===t.length)return[e,i];return Rt(t[t.length-1],[e,i],this._pxToUnits(10))}_snappedVertexPoint(t,e,i,n,s,o){if(o)return[i,n];const l=this._pxToUnits(10),r=e>0?e-1:s?t.length-1:-1;if(r>=0&&r!==e)return Rt(t[r],[i,n],l);const a=e<t.length-1?e+1:s?0:-1;return a>=0&&a!==e?Rt(t[a],[i,n],l):[i,n]}_effectiveOpening(t){return this._liveOpeningEdit?.id===t.id?{...t,x:this._liveOpeningEdit.x,y:this._liveOpeningEdit.y,width:this._liveOpeningEdit.width}:t}_openingEndpoints(t){const e=this.walls.find(e=>e.id===t.wallId);if(!e)return null;const i=this._effectivePoints("wall",e.id,e.points),n=this._effectiveOpening(t);return zt(n.x,n.y,n.width,i)}_snappedWallPoint(t,e,i,n){if(!n){const t=this._pxToUnits(ie),n=Zt(this.walls,e,i,t);if(n)return Ft(n.points,e,i).point}return this._snappedTracePoint(t,e,i,n)}_hitTest(t,e,i){const n=this._pxToUnits(ie);if("select"!==this.mode)return{type:"empty"};const s=this._editingTarget;if(s&&this._liveEditPoints){const t=this._liveEditPoints,e=Gt(t,i.x,i.y,n);if(null!==e)return{type:"vertex",index:e};const o=Gt("room"===s.kind?At(t):Lt(t),i.x,i.y,n);return null!==o?{type:"edgeMidpoint",index:o}:{type:"empty"}}const o=Kt(this.pins,i.x,i.y,n);if(o.length>1)return{type:"pinStack",pins:o};if(1===o.length)return{type:"pin",pin:o[0]};const l=function(t,e,i,n){let s=null,o=n;for(const n of t){const t=Bt(e,i,[[n.fromPin.x,n.fromPin.y],[n.toPin.x,n.toPin.y]]);t<=o&&(s=n,o=t)}return s}(this.meshLinks,i.x,i.y,n);if(l)return{type:"meshLink",link:l};const r=function(t,e,i,n){let s=null,o=n;for(const n of t){const t=Math.min(Mt(n.x,n.y,e,i),Bt(e,i,[[n.fromPin.x,n.fromPin.y],[n.x,n.y]]));t<=o&&(s=n,o=t)}return s}(this.meshStubs,i.x,i.y,n);if(r)return{type:"meshStub",stub:r};if(this.selectedOpeningId){const t=this.openings.find(t=>t.id===this.selectedOpeningId),e=t?this._openingEndpoints(t):null;if(t&&e){const s=Gt(e,i.x,i.y,n);if(null!==s)return{type:"openingHandle",opening:t,whichEnd:s}}}const a=function(t,e,i,n,s){let o=null,l=s;for(const s of t){const t=e.find(t=>t.id===s.wallId);if(!t)continue;const r=zt(s.x,s.y,s.width,t.points);if(!r)continue;const a=Bt(i,n,r);a<=l&&(o=s,l=a)}return o}(this.openings,this.walls,i.x,i.y,n);if(a)return{type:"opening",opening:a};const d=Zt(this.walls,i.x,i.y,n);if(d)return{type:"wall",wall:d};const c=this.rooms.find(t=>t.points.length>=3&&Tt(i.x,i.y,t.points));return c?{type:"room",room:c}:{type:"empty"}}_lockGesture(){return"align"===this.mode?{kind:"alignDrag"}:"vertex"===this._downHit?.type?{kind:"vertex",index:this._downHit.index}:"pin"===this._downHit?.type?{kind:"pin",pinId:this._downHit.pin.id}:"openingHandle"===this._downHit?.type?{kind:"openingHandle",openingId:this._downHit.opening.id,whichEnd:this._downHit.whichEnd}:"opening"===this._downHit?.type?{kind:"openingMove",openingId:this._downHit.opening.id}:{kind:"pan"}}_dispatchVertexChanged(t){const e=this._editingTarget;if(!e)return;const i="room"===e.kind?"room-vertex-changed":"wall-vertex-changed",n="room"===e.kind?"roomId":"wallId";this.dispatchEvent(new CustomEvent(i,{detail:{[n]:e.id,points:t}}))}_commitGesture(){"vertex"===this._gesture?.kind&&this._editingTarget&&this._liveEditPoints?this._dispatchVertexChanged(this._liveEditPoints):"pin"===this._gesture?.kind&&this._liveDragPin?(this.dispatchEvent(new CustomEvent("pin-move",{detail:{pinId:this._liveDragPin.id,x:this._liveDragPin.x,y:this._liveDragPin.y}})),this._liveDragPin=null):"openingMove"!==this._gesture?.kind&&"openingHandle"!==this._gesture?.kind||!this._liveOpeningEdit||(this.dispatchEvent(new CustomEvent("opening-update",{detail:{openingId:this._liveOpeningEdit.id,x:this._liveOpeningEdit.x,y:this._liveOpeningEdit.y,width:this._liveOpeningEdit.width}})),this._liveOpeningEdit=null)}_handleClick(t,e,i=!1){const n=this._clientToImage(t,e);if("trace"===this.mode){const t=this._pxToUnits(ie),e=this._pendingTrace??{points:[]},[s,o]=this._snappedTracePoint(e.points,n.x,n.y,i),l=Jt(e,s,o,t);return void(l.closed?(this.dispatchEvent(new CustomEvent("room-trace-complete",{detail:{points:e.points}})),this._pendingTrace=null):this._pendingTrace=l.trace)}if("wall"===this.mode){const t=this._pxToUnits(ie),e=this._pendingTrace??{points:[]},[s,o]=this._snappedWallPoint(e.points,n.x,n.y,i),l=Jt(e,s,o,t);return void(l.closed?(this.dispatchEvent(new CustomEvent("wall-trace-complete",{detail:{points:[...e.points,e.points[0]]}})),this._pendingTrace=null):this._pendingTrace=l.trace)}if("opening"===this.mode){if(!this.armedOpeningType)return;const t=this._pxToUnits(ie),e=Zt(this.walls,n.x,n.y,t);if(!e)return;const{point:i}=Ft(e.points,n.x,n.y);return void this.dispatchEvent(new CustomEvent("opening-place",{detail:{wallId:e.id,x:i[0],y:i[1]}}))}if("scale"===this.mode){const t=[...this._pendingScalePoints,[n.x,n.y]];return void(t.length>=2?(this.dispatchEvent(new CustomEvent("scale-line-complete",{detail:{points:t.slice(0,2)}})),this._pendingScalePoints=[]):this._pendingScalePoints=t)}if("place"===this.mode){if(this.armedEntityId){const t=this._pxToUnits(ie),e=Kt(this.pins,n.x,n.y,t)[0],i=e?.x??n.x,s=e?.y??n.y;this.dispatchEvent(new CustomEvent("pin-place",{detail:{x:i,y:s}}))}return}const s=this._downHit??{type:"empty"};if("vertex"===s.type)this._selectedVertexIndex=this._selectedVertexIndex===s.index?null:s.index;else if("edgeMidpoint"===s.type&&this._editingTarget&&this._liveEditPoints){const t=("room"===this._editingTarget.kind?At(this._liveEditPoints):Lt(this._liveEditPoints))[s.index],e=[...this._liveEditPoints];e.splice(s.index+1,0,t),this._liveEditPoints=e,this._dispatchVertexChanged(e)}else if("pin"===s.type)this.dispatchEvent(new CustomEvent("pin-select",{detail:{pinId:this.selectedPinId===s.pin.id?null:s.pin.id}}));else if("pinStack"===s.type)this.dispatchEvent(new CustomEvent("pin-stack-select",{detail:{pinIds:s.pins.map(t=>t.id)}}));else if("room"===s.type)this.dispatchEvent(new CustomEvent("room-select",{detail:{roomId:this.selectedRoomId===s.room.id?null:s.room.id}}));else if("wall"===s.type)this.dispatchEvent(new CustomEvent("wall-select",{detail:{wallId:this.selectedWallId===s.wall.id?null:s.wall.id}}));else if("opening"===s.type)this.dispatchEvent(new CustomEvent("opening-select",{detail:{openingId:this.selectedOpeningId===s.opening.id?null:s.opening.id}}));else if("meshLink"===s.type){const t=`${s.link.fromPin.id}|${s.link.toPin.id}`;this.dispatchEvent(new CustomEvent("mesh-link-select",{detail:{link:this.selectedMeshLinkKey===t?null:s.link}}))}else if("meshStub"===s.type){const t=`${s.stub.fromPin.id}|${s.stub.targetDeviceId}`;this.dispatchEvent(new CustomEvent("mesh-stub-select",{detail:{stub:this.selectedMeshStubKey===t?null:s.stub}}))}else if(this._editingTarget&&null!==this._selectedVertexIndex&&this._liveEditPoints){const t="room"===this._editingTarget.kind,[e,s]=this._snappedVertexPoint(this._liveEditPoints,this._selectedVertexIndex,n.x,n.y,t,i),o=[...this._liveEditPoints];o[this._selectedVertexIndex]=[e,s],this._liveEditPoints=o,this._selectedVertexIndex=null,this._dispatchVertexChanged(o)}else this._selectedVertexIndex=null,this.dispatchEvent(new CustomEvent("room-select",{detail:{roomId:null}})),this.dispatchEvent(new CustomEvent("pin-select",{detail:{pinId:null}})),this.dispatchEvent(new CustomEvent("wall-select",{detail:{wallId:null}})),this.dispatchEvent(new CustomEvent("opening-select",{detail:{openingId:null}})),this.dispatchEvent(new CustomEvent("mesh-link-select",{detail:{link:null}})),this.dispatchEvent(new CustomEvent("mesh-stub-select",{detail:{stub:null}}))}finishPendingWall(){"wall"!==this.mode||!this._pendingTrace||this._pendingTrace.points.length<2||(this.dispatchEvent(new CustomEvent("wall-trace-complete",{detail:{points:this._pendingTrace.points}})),this._pendingTrace=null)}cancelPending(){this._pendingTrace=null,this._pendingScalePoints=[]}_deleteSelectedVertex(){const t=this._editingTarget;if(null===this._selectedVertexIndex||!t||!this._liveEditPoints)return;const e="room"===t.kind?3:2;if(this._liveEditPoints.length<=e)return;const i=this._liveEditPoints.filter((t,e)=>e!==this._selectedVertexIndex);this._liveEditPoints=i,this._selectedVertexIndex=null,this._dispatchVertexChanged(i)}_zoomBy(t,e){const i=Ct(this._viewBox.w*t,250,4e3),n=i/this._viewBox.w,s=this._viewBox.h*n;this._viewBox={x:e.x-(e.x-this._viewBox.x)*n,y:e.y-(e.y-this._viewBox.y)*n,w:i,h:s}}_zoomButton(t){const e=this._viewBox;this._zoomBy(t,{x:e.x+e.w/2,y:e.y+e.h/2})}_pinLabel(t){return t.label_override?t.label_override:vt(t.device_id,this.entityLookup.values())}_renderRoom(t){const e=this._effectivePoints("room",t.id,t.points);if(e.length<2)return j;const i=e.map(([t,e])=>`${t},${e}`).join(" "),[n,s]=function(t){if(0===t.length)return[0,0];let e=0,i=0;for(const[n,s]of t)e+=n,i+=s;return[e/t.length,i/t.length]}(e),o=this.editingRoomId===t.id;return Y`
    ...
    `}_renderVertexHandles(t,e){const i=this._pxToUnits(6),n=this._pxToUnits(4),s=e?At(t):Lt(t);return Y`
    ...
    `}_renderOpening(t){const e=this._openingEndpoints(t);if(!e)return j;const[[i,n],[s,o]]=e,l=t.id===this.selectedOpeningId,r=this._pxToUnits(6),a=this.walls.find(e=>e.id===t.wallId),d=a?this._wallStrokeWidth(a,xt(a.material)):void 0,c=Mt(i,n,s,o)||1,h=parseFloat(d??"6")/2*1.5,p=-(o-n)/c*h,u=(s-i)/c*h,_=(t,e)=>Y`
      <line
    ...
    `}_renderScaleLine(){if(!this.scale)return j;const[[t,e],[i,n]]=this.scale.points;return Y`
      ...
      <text class="scale-label" x=${(t+i)/2} y=${(e+n)/2-6}>
        ${Ht(this.scale.meters,this.unitSystem)}
        ${Ut(this.unitSystem)}
      </text>
    `}_renderPendingScale(){if(0===this._pendingScalePoints.length)return j;const t=this._pxToUnits(6),[e,i]=this._pendingScalePoints[0];return Y`<circle class="vertex-handle" cx=${e} cy=${i} r=${t}></circle>`}_renderBackgroundOverlay(){if(!this.backgroundImageUrl)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.backgroundOffsetX-this._viewBox.x),s=i+t*(this.backgroundOffsetY-this._viewBox.y),o=t*this.backgroundScale;return V`
      ...
      >
        <img
          ...
          style="width:${te}px; height:${this._naturalHeight}px; opacity:${this.backgroundOpacity};"
        />
      </div>
    `}_renderAlignOverlay(){if(!this.alignOverlay)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.alignOverlay.offsetX-this._viewBox.x),s=i+t*(this.alignOverlay.offsetY-this._viewBox.y),o=t*this.alignOverlay.scale;return V`
      ...
      >
        <img
          ...
          style="width:${te}px; height:${this._alignNaturalHeight}px; opacity:${this.alignOverlay.opacity};"
        />
      </div>
    ...
    `],t([_t({attribute:!1})],oe.prototype,"placements",void 0),t([_t({attribute:!1})],oe.prototype,"floorNameById",void 0),t([_t({attribute:!1})],oe.prototype,"floorIconById",void 0),t([_t({attribute:!1})],oe.prototype,"backgroundImageUrl",void 0),t([_t({type:Number})],oe.prototype,"backgroundOpacity",void 0),t([_t({type:Number})],oe.prototype,"backgroundOffsetX",void 0),t([_t({type:Number})],oe.prototype,"backgroundOffsetY",void 0),t([_t({type:Number})],oe.prototype,"backgroundScale",void 0),t([_t({attribute:!1})],oe.prototype,"mode",void 0),t([_t({attribute:!1})],oe.prototype,"selectedPlacementId",void 0),t([_t({attribute:!1})],oe.prototype,"initialViewBox",void 0),t([gt()],oe.prototype,"_viewBox",void 0),t([gt()],oe.prototype,"_naturalHeight",void 0),t([mt("svg")],oe.prototype,"_svg",void 0),oe=t([ht("property-canvas")],oe);let le=class extends dt{constructor(){super(...arguments),this.floors=[],this.selectedFloorId=null,this.propertySelected=!1}render(){return V`
      ${this.floors.map(t=>V`
          <button
    ...
    `],t([_t({attribute:!1})],le.prototype,"floors",void 0),t([_t({attribute:!1})],le.prototype,"selectedFloorId",void 0),t([_t({type:Boolean})],le.prototype,"propertySelected",void 0),le=t([ht("floor-tabs")],le);let re=class extends dt{constructor(){super(...arguments),this.floors=[],this.selectedFloorId=null,this.propertySelected=!1,this.dirty=!1,this.saving=!1}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}render(){return V`
      <div class="identity">
    ...
    `}_renderHintBar(){return"trace"===this.mode&&this.hasPendingTrace?V`<div class="hint-bar floating-panel">
      ...
      `}if(this.selectedWall){const t=this.selectedWall,e=this._wallThicknessUnit??Yt(this.unitSystem),i=this._thicknessInputAttrs(e);return V`
        <div class="selection-panel floating-panel">
          ...
          <input
            ...
            step=${i.step}
            .value=${Xt(wt(t),e)}
            @change=${t=>{const i=jt(t.target.value,e);null===i||!Number.isFinite(i)||i<=0||this._fire("wall-thickness-change",{thicknessCm:i})}}
          />
      ...
      `}if(this.selectedOpening){const t=this.selectedOpening,e=this._openingWidthUnit??Yt(this.unitSystem),i=this._thicknessInputAttrs(e),n=this.unitsPerMeter;return V`
        <div class="selection-panel floating-panel">
          ...
          <input
            ...
            .value=${null!==n?function(t,e,i){return Xt(t/e*100,i)}(t.width,n,e):String(t.width)}
            @change=${t=>{const i=t.target.value,s=null!==n?function(t,e,i){const n=jt(t,i);return null===n?null:n/100*e}(i,n,e):Number(i);null===s||!Number.isFinite(s)||s<=0||this._fire("opening-width-change",{width:s})}}
          />
    ...
    `],t([_t({attribute:!1})],ae.prototype,"mode",void 0),t([_t({attribute:!1})],ae.prototype,"armedOpeningType",void 0),t([_t({type:Boolean})],ae.prototype,"hasPendingTrace",void 0),t([_t({type:Boolean})],ae.prototype,"hasPendingWall",void 0),t([_t({type:Number})],ae.prototype,"pendingScaleCount",void 0),t([_t({attribute:!1})],ae.prototype,"scaleReadout",void 0),t([_t({attribute:!1})],ae.prototype,"selectedRoom",void 0),t([_t({type:Boolean})],ae.prototype,"editingRoom",void 0),t([_t({attribute:!1})],ae.prototype,"areas",void 0),t([_t({attribute:!1})],ae.prototype,"selectedPin",void 0),t([_t({attribute:!1})],ae.prototype,"selectedWall",void 0),t([_t({type:Boolean})],ae.prototype,"editingWall",void 0),t([_t({attribute:!1})],ae.prototype,"unitSystem",void 0),t([_t({type:Number})],ae.prototype,"unitsPerMeter",void 0),t([_t({attribute:!1})],ae.prototype,"pinStack",void 0),t([_t({attribute:!1})],ae.prototype,"entityLookup",void 0),t([_t({attribute:!1})],ae.prototype,"selectedOpening",void 0),t([_t({attribute:!1})],ae.prototype,"selectedMeshLink",void 0),t([_t({attribute:!1})],ae.prototype,"selectedMeshStub",void 0),t([_t({attribute:!1})],ae.prototype,"otherFloors",void 0),t([_t({attribute:!1})],ae.prototype,"alignTargetFloorId",void 0),t([_t({type:Boolean})],ae.prototype,"alignTargetHasBackground",void 0),t([gt()],ae.prototype,"_wallThicknessUnit",void 0),t([gt()],ae.prototype,"_openingWidthUnit",void 0),ae=t([ht("canvas-overlay")],ae);let de=class extends dt{constructor(){super(...arguments),this.icon="",this.label="",this.open=!1}render(){return V`
      <button
    ...
    `],t([_t({attribute:!1})],ce.prototype,"entities",void 0),t([_t({attribute:!1})],ce.prototype,"placedDeviceIds",void 0),t([_t({attribute:!1})],ce.prototype,"armedEntityId",void 0),t([_t({attribute:!1})],ce.prototype,"floors",void 0),t([_t({attribute:!1})],ce.prototype,"areas",void 0),t([_t({attribute:!1})],ce.prototype,"currentFloorId",void 0),t([gt()],ce.prototype,"_search",void 0),t([gt()],ce.prototype,"_floorFilter",void 0),t([gt()],ce.prototype,"_areaFilter",void 0),ce=t([ht("entity-picker-sidebar")],ce);let he=class extends dt{constructor(){super(...arguments),this.mode="select",this.buildings=[],this.armedBuildingKey=null,this.selectedPlacement=null,this.floorNameById=new Map}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_selectedLabel(){const t=this.selectedPlacement;return t?t.label_override||this.floorNameById.get(t.floor_id)||t.floor_id:""}render(){return V`
      <div class="mode-toolbar floating-panel">
        <button
    ...
    `],t([gt()],pe.prototype,"_floors",void 0),t([gt()],pe.prototype,"_currentFloorId",void 0),t([gt()],pe.prototype,"_layout",void 0),t([gt()],pe.prototype,"_entities",void 0),t([gt()],pe.prototype,"_areas",void 0),t([gt()],pe.prototype,"_mode",void 0),t([gt()],pe.prototype,"_armedEntityId",void 0),t([gt()],pe.prototype,"_armedOpeningType",void 0),t([gt()],pe.prototype,"_selectedRoomId",void 0),t([gt()],pe.prototype,"_editingRoomId",void 0),t([gt()],pe.prototype,"_selectedPinId",void 0),t([gt()],pe.prototype,"_pinStackIds",void 0),t([gt()],pe.prototype,"_selectedWallId",void 0),t([gt()],pe.prototype,"_editingWallId",void 0),t([gt()],pe.prototype,"_selectedOpeningId",void 0),t([gt()],pe.prototype,"_selectedMeshLink",void 0),t([gt()],pe.prototype,"_selectedMeshStub",void 0),t([gt()],pe.prototype,"_otherFloorPinsByDeviceId",void 0),t([gt()],pe.prototype,"_dirty",void 0),t([gt()],pe.prototype,"_saving",void 0),t([gt()],pe.prototype,"_loading",void 0),t([gt()],pe.prototype,"_pendingCount",void 0),t([gt()],pe.prototype,"_networkType",void 0),t([gt()],pe.prototype,"_zigbeeMesh",void 0),t([gt()],pe.prototype,"_zigbeeMeshLoading",void 0),t([gt()],pe.prototype,"_zigbeeMeshError",void 0),t([gt()],pe.prototype,"_zigbeeMeshFetchedAt",void 0),t([gt()],pe.prototype,"_zigbeeMeshElapsedSeconds",void 0),t([gt()],pe.prototype,"_wifiMesh",void 0),t([gt()],pe.prototype,"_wifiMeshLoading",void 0),t([gt()],pe.prototype,"_wifiMeshError",void 0),t([gt()],pe.prototype,"_wifiMeshFetchedAt",void 0),t([gt()],pe.prototype,"_matterTopology",void 0),t([gt()],pe.prototype,"_matterError",void 0),t([gt()],pe.prototype,"_backgroundPopoverOpen",void 0),t([gt()],pe.prototype,"_meshPopoverOpen",void 0),t([gt()],pe.prototype,"_settings",void 0),t([gt()],pe.prototype,"_settingsPopoverOpen",void 0),t([gt()],pe.prototype,"_moreOptionsPopoverOpen",void 0),t([gt()],pe.prototype,"_view",void 0),t([gt()],pe.prototype,"_propertyLayout",void 0),t([gt()],pe.prototype,"_propertyDirty",void 0),t([gt()],pe.prototype,"_propertySaving",void 0),t([gt()],pe.prototype,"_selectedPlacementId",void 0),t([gt()],pe.prototype,"_propertyMode",void 0),t([gt()],pe.prototype,"_armedBuildingKey",void 0),t([gt()],pe.prototype,"_sameBuildingAsPreviousFloor",void 0),t([gt()],pe.prototype,"_alignTargetFloorId",void 0),t([gt()],pe.prototype,"_alignTargetLayout",void 0),t([gt()],pe.prototype,"_alignOffsetX",void 0),t([gt()],pe.prototype,"_alignOffsetY",void 0),t([gt()],pe.prototype,"_alignScale",void 0),t([mt("floorplan-canvas")],pe.prototype,"_canvas",void 0),t([mt("property-canvas")],pe.prototype,"_propertyCanvas",void 0),t([mt("#file-input")],pe.prototype,"_fileInput",void 0),pe=t([ht("spatial-context-panel")],pe)}();

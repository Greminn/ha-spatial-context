...
`;function Gt(t,e,i,n){return t.map(t=>({pin:t,d:Mt(t.x,t.y,e,i)})).filter(({d:t})=>t<=n).sort((t,e)=>t.d-e.d).map(({pin:t})=>t)}function Zt(t,e,i,n){let s=null,o=n;return t.forEach(([t,n],l)=>{const r=Mt(t,n,e,i);r<=o&&(s=l,o=r)}),s}function Jt(t,e,i,n){let s=null,o=n;for(const n of t){const t=Bt(e,i,n.points);t<=o&&(s=n,o=t)}return s}function Qt(t,e,i,n){if(t.points.length>=3){const[s,o]=t.points[0];if(Mt(s,o,e,i)<=n)return{trace:t,closed:!0}}return{trace:{points:[...t.points,[e,i]]},closed:!1}}const te=new Map;const ee=1e3,ie=750,ne=14,se="#03a9f4";let oe=class extends ct{constructor(){super(...arguments),this.rooms=[],this.pins=[],this.walls=[],this.openings=[],this.scale=null,this.unitSystem="metric",this.meshLinks=[],this.meshStubs=[],this.entityLookup=new Map,this.backgroundImageUrl=null,this.backgroundOpacity=.5,this.backgroundOffsetX=0,this.backgroundOffsetY=0,this.backgroundScale=1,this.alignOverlay=null,this.initialViewBox=null,this.sameBuildingAsPrevious=!1,this.mode="select",this.armedEntityId=null,this.armedOpeningType=null,this.selectedRoomId=null,this.editingRoomId=null,this.editingWallId=null,this.selectedPinId=null,this.selectedWallId=null,this.selectedOpeningId=null,this.selectedMeshLinkKey=null,this.selectedMeshStubKey=null,this._viewBox={x:0,y:0,w:ee,h:ie},this._naturalHeight=ie,this._alignNaturalHeight=ie,this._pendingTrace=null,this._hoverSnap=null,this._pendingScalePoints=[],this._liveEditPoints=null,this._liveDragPin=null,this._liveOpeningEdit=null,this._selectedVertexIndex=null,this._pointers=new Map,this._downHit=null,this._downClient=null,this._lastImage=null,this._lastClient=null,this._gesture=null,this._moved=!1,this._hasFittedOnce=!1,this._onPointerDown=t=>{if("mouse"===t.pointerType&&0!==t.button)return;if(this._svg.setPointerCapture(t.pointerId),this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n={x:(e.x+i.x)/2,y:(e.y+i.y)/2};return void(this._gesture={kind:"pinch",startDistance:Mt(e.x,e.y,i.x,i.y),startViewBox:{...this._viewBox},midImage:this._clientToImage(n.x,n.y)})}if(this._pointers.size>2)return;const e=this._clientToImage(t.clientX,t.clientY);this._downClient={x:t.clientX,y:t.clientY},this._lastImage=e,this._lastClient={x:t.clientX,y:t.clientY},this._moved=!1,this._gesture=null,this._downHit="select"===this.mode?this._hitTest(t.clientX,t.clientY,e):{type:"empty"}},this._onPointerMove=t=>{if(!this._pointers.has(t.pointerId)){if("wall"===this.mode||"trace"===this.mode){const e=this._clientToImage(t.clientX,t.clientY);this._hoverSnap=this._snappedGeometryPoint(this._pendingTrace?.points??[],e.x,e.y,t.shiftKey)}else this._hoverSnap&&(this._hoverSnap=null);return}if(this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),"pinch"===this._gesture?.kind&&2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n=Mt(e.x,e.y,i.x,i.y)||1,s=this._gesture.startDistance/n,o=this._gesture.startViewBox,l=Ct(o.w*s,250,4e3),r=l/o.w,a=o.h*r,{x:c,y:d}=this._gesture.midImage;return void(this._viewBox={x:c-(c-o.x)*r,y:d-(d-o.y)*r,w:l,h:a})}if(1!==this._pointers.size||!this._downClient||!this._lastImage)return;if(!this._moved){if(Mt(this._downClient.x,this._downClient.y,t.clientX,t.clientY)<5)return;this._moved=!0,this._gesture=this._lockGesture(),"pan"!==this._gesture?.kind&&"alignDrag"!==this._gesture?.kind||(this._svg.style.cursor="grabbing")}const e=this._clientToImage(t.clientX,t.clientY);if("pan"===this._gesture?.kind){const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};this._viewBox={...this._viewBox,x:this._viewBox.x-(t.clientX-i.x)/e,y:this._viewBox.y-(t.clientY-i.y)/e}}else if("alignDrag"===this._gesture?.kind){const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};this.dispatchEvent(new CustomEvent("align-drag",{detail:{dx:(t.clientX-i.x)/e,dy:(t.clientY-i.y)/e}}))}else if("vertex"===this._gesture?.kind&&this._liveEditPoints){const i="room"===this._editingTarget?.kind,[n,s]=this._snappedVertexPoint(this._liveEditPoints,this._gesture.index,e.x,e.y,i,t.shiftKey),o=[...this._liveEditPoints];o[this._gesture.index]=[n,s],this._liveEditPoints=o}else if("pin"===this._gesture?.kind)this._liveDragPin={id:this._gesture.pinId,x:e.x,y:e.y};else if("openingMove"===this._gesture?.kind){const t=this._gesture,i=this.openings.find(e=>e.id===t.openingId),n=i&&this.walls.find(t=>t.id===i.wallId);if(i&&n){const t=this._effectivePoints("wall",n.id,n.points),{point:s}=Ft(t,e.x,e.y);this._liveOpeningEdit={id:i.id,x:s[0],y:s[1],width:i.width}}}else if("openingHandle"===this._gesture?.kind){const t=this._gesture,i=this.openings.find(e=>e.id===t.openingId),n=i&&this.walls.find(t=>t.id===i.wallId),s=i&&this._openingEndpoints(i);if(i&&n&&s){const o=this._effectivePoints("wall",n.id,n.points),{point:l}=Ft(o,e.x,e.y),r=s[0===t.whichEnd?1:0],a=[(r[0]+l[0])/2,(r[1]+l[1])/2],c=Mt(r[0],r[1],l[0],l[1]);this._liveOpeningEdit={id:i.id,x:a[0],y:a[1],width:c}}}this._lastImage=this._clientToImage(t.clientX,t.clientY),this._lastClient={x:t.clientX,y:t.clientY}},this._onPointerLeave=()=>{this._hoverSnap=null},this._onPointerUp=t=>{this._pointers.delete(t.pointerId),this._svg.style.cursor="";try{this._svg.releasePointerCapture(t.pointerId)}catch{}this._pointers.size>=1?this._gesture=null:(this._moved?this._commitGesture():this._downClient&&this._handleClick(this._downClient.x,this._downClient.y,t.shiftKey),this._gesture=null,this._downHit=null,this._downClient=null,this._moved=!1)},this._onWheel=t=>{if(t.preventDefault(),t.ctrlKey){const e=t.deltaY<0?.9:1.1;return void this._zoomBy(e,this._clientToImage(t.clientX,t.clientY))}const e=this._viewBox.w/this.getBoundingClientRect().width;this._viewBox={...this._viewBox,x:this._viewBox.x+t.deltaX*e,y:this._viewBox.y+t.deltaY*e}},this._resolvedIconOverrides=new Map,this._failedBrandIcons=new Set}get _editingTarget(){return this.editingRoomId?{kind:"room",id:this.editingRoomId}:this.editingWallId?{kind:"wall",id:this.editingWallId}:null}_rawPointsFor(t){return"room"===t.kind?this.rooms.find(e=>e.id===t.id)?.points??null:this.walls.find(e=>e.id===t.id)?.points??null}willUpdate(t){if(t.has("editingRoomId")||t.has("editingWallId")){const t=this._editingTarget,e=t?this._rawPointsFor(t):null;this._liveEditPoints=e?[...e]:null,this._selectedVertexIndex=null}t.has("mode")&&(this._pendingTrace=null,this._pendingScalePoints=[])}firstUpdated(){this.fitToScreen(),this._hasFittedOnce=null!==this._contentBounds()||!this.backgroundImageUrl,this._resizeObserver=new ResizeObserver(()=>this.requestUpdate()),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect()}updated(t){if(t.has("backgroundImageUrl")&&this.backgroundImageUrl){const t=new Image;t.onload=()=>{this._naturalHeight=t.naturalHeight/t.naturalWidth*ee||ie,this._hasFittedOnce||(this.fitToScreen(),this._hasFittedOnce=!0)},t.src=this.backgroundImageUrl}if(t.has("initialViewBox")&&(this.initialViewBox?(this._viewBox={...this.initialViewBox},this._hasFittedOnce=!0):this.sameBuildingAsPrevious||(this.fitToScreen(),this._hasFittedOnce=null!==this._contentBounds()||!this.backgroundImageUrl)),t.has("alignOverlay")){const e=t.get("alignOverlay");if(this.alignOverlay&&this.alignOverlay.imageUrl!==e?.imageUrl){const t=new Image;t.onload=()=>{this._alignNaturalHeight=t.naturalHeight/t.naturalWidth*ee||ie},t.src=this.alignOverlay.imageUrl}}if(t.has("_pendingTrace")||t.has("_pendingScalePoints")){const t="scale"===this.mode?this._pendingScalePoints.length:this._pendingTrace?.points.length??0;this.dispatchEvent(new CustomEvent("pending-changed",{detail:{count:t}}))}}_contentBounds(){const t=[];for(const e of this.rooms)t.push(...e.points);for(const e of this.walls)t.push(...e.points);for(const e of this.pins)t.push([e.x,e.y]);if(0===t.length)return null;const e=t.map(([t])=>t),i=t.map(([,t])=>t),n=Math.min(...e),s=Math.max(...e),o=Math.min(...i),l=Math.max(...i),r=.08*Math.max(s-n,l-o)||40;return{x:n-r,y:o-r,w:s-n+2*r,h:l-o+2*r}}fitToScreen(){this._viewBox=this._contentBounds()??{x:0,y:0,w:ee,h:this._naturalHeight}}getViewBox(){return{...this._viewBox}}_svgTransform(){const t=this._svg?.getBoundingClientRect(),e=t?.width||this._viewBox.w,i=t?.height||this._viewBox.h,n=Math.min(e/this._viewBox.w,i/this._viewBox.h)||1;return{scale:n,offsetX:(e-this._viewBox.w*n)/2,offsetY:(i-this._viewBox.h*n)/2}}_pxToUnits(t){return t/this._svgTransform().scale}_clientToImage(t,e){const i=this._svg,n=i.createSVGPoint();n.x=t,n.y=e;const s=i.getScreenCTM();if(!s)return{x:0,y:0};const o=n.matrixTransform(s.inverse());return{x:o.x,y:o.y}}_effectivePoints(t,e,i){const n=this._editingTarget;return n&&n.kind===t&&n.id===e&&this._liveEditPoints?this._liveEditPoints:i}_snappedTracePoint(t,e,i,n){if(n||0===t.length)return{point:[e,i],lockedX:!1,lockedY:!1};const s=this._pxToUnits(10),o=t[t.length-1],l=t[0],r=t.length>=3&&(l[0]!==o[0]||l[1]!==o[1])?[o,l]:[o];let a=null,c=1/0,d=null,h=1/0;for(const[t,n]of r){const o=Math.abs(e-t),l=Math.abs(i-n);o>s&&l>s||(o<=l?o<c&&(a=t,c=o):l<h&&(d=n,h=l))}return{point:[a??e,d??i],lockedX:null!==a,lockedY:null!==d}}_snappedVertexPoint(t,e,i,n,s,o){if(o)return[i,n];const l=this._pxToUnits(10),r=e>0?e-1:s?t.length-1:-1;if(r>=0&&r!==e)return Dt(t[r],[i,n],l);const a=e<t.length-1?e+1:s?0:-1;return a>=0&&a!==e?Dt(t[a],[i,n],l):[i,n]}_effectiveOpening(t){return this._liveOpeningEdit?.id===t.id?{...t,x:this._liveOpeningEdit.x,y:this._liveOpeningEdit.y,width:this._liveOpeningEdit.width}:t}_openingEndpoints(t){const e=this.walls.find(e=>e.id===t.wallId);if(!e)return null;const i=this._effectivePoints("wall",e.id,e.points),n=this._effectiveOpening(t);return Wt(n.x,n.y,n.width,i)}_snappedGeometryPoint(t,e,i,n){if(!n){const t=this._pxToUnits(ne);let n=null;for(const s of this.walls){const o=parseFloat(this._wallStrokeWidth(s,xt(s.material)))/2,l=Math.max(t,o);if(Bt(e,i,s.points)>l)continue;const r=Ft(s.points,e,i).point,a=Mt(e,i,r[0],r[1]);(!n||a<n.dist)&&(n={point:r,dist:a})}const s=function(t,e,i,n){let s=null,o=n;for(const n of t){if(n.points.length<2)continue;const{point:t}=Rt(n.points,e,i),l=Mt(e,i,t[0],t[1]);l<=o&&(s=n,o=l)}return s}(this.rooms,e,i,t);if(s){const t=Rt(s.points,e,i).point,o=Mt(e,i,t[0],t[1]);(!n||o<n.dist)&&(n={point:t,dist:o})}if(n)return{point:n.point,kind:"geometry",lockedX:!1,lockedY:!1}}const{point:s,lockedX:o,lockedY:l}=this._snappedTracePoint(t,e,i,n);return{point:s,kind:o||l?"axis":"none",lockedX:o,lockedY:l}}_hitTest(t,e,i){const n=this._pxToUnits(ne);if("select"!==this.mode)return{type:"empty"};const s=this._editingTarget;if(s&&this._liveEditPoints){const t=this._liveEditPoints,e=Zt(t,i.x,i.y,n);if(null!==e)return{type:"vertex",index:e};const o=Zt("room"===s.kind?Lt(t):At(t),i.x,i.y,n);return null!==o?{type:"edgeMidpoint",index:o}:{type:"empty"}}const o=Gt(this.pins,i.x,i.y,n);if(o.length>1)return{type:"pinStack",pins:o};if(1===o.length)return{type:"pin",pin:o[0]};const l=function(t,e,i,n){let s=null,o=n;for(const n of t){const t=Bt(e,i,[[n.fromPin.x,n.fromPin.y],[n.toPin.x,n.toPin.y]]);t<=o&&(s=n,o=t)}return s}(this.meshLinks,i.x,i.y,n);if(l)return{type:"meshLink",link:l};const r=function(t,e,i,n){let s=null,o=n;for(const n of t){const t=Math.min(Mt(n.x,n.y,e,i),Bt(e,i,[[n.fromPin.x,n.fromPin.y],[n.x,n.y]]));t<=o&&(s=n,o=t)}return s}(this.meshStubs,i.x,i.y,n);if(r)return{type:"meshStub",stub:r};if(this.selectedOpeningId){const t=this.openings.find(t=>t.id===this.selectedOpeningId),e=t?this._openingEndpoints(t):null;if(t&&e){const s=Zt(e,i.x,i.y,n);if(null!==s)return{type:"openingHandle",opening:t,whichEnd:s}}}const a=function(t,e,i,n,s){let o=null,l=s;for(const s of t){const t=e.find(t=>t.id===s.wallId);if(!t)continue;const r=Wt(s.x,s.y,s.width,t.points);if(!r)continue;const a=Bt(i,n,r);a<=l&&(o=s,l=a)}return o}(this.openings,this.walls,i.x,i.y,n);if(a)return{type:"opening",opening:a};const c=Jt(this.walls,i.x,i.y,n);if(c)return{type:"wall",wall:c};const d=this.rooms.find(t=>t.points.length>=3&&Tt(i.x,i.y,t.points));return d?{type:"room",room:d}:{type:"empty"}}_lockGesture(){return"align"===this.mode?{kind:"alignDrag"}:"vertex"===this._downHit?.type?{kind:"vertex",index:this._downHit.index}:"pin"===this._downHit?.type?{kind:"pin",pinId:this._downHit.pin.id}:"openingHandle"===this._downHit?.type?{kind:"openingHandle",openingId:this._downHit.opening.id,whichEnd:this._downHit.whichEnd}:"opening"===this._downHit?.type?{kind:"openingMove",openingId:this._downHit.opening.id}:{kind:"pan"}}_dispatchVertexChanged(t){const e=this._editingTarget;if(!e)return;const i="room"===e.kind?"room-vertex-changed":"wall-vertex-changed",n="room"===e.kind?"roomId":"wallId";this.dispatchEvent(new CustomEvent(i,{detail:{[n]:e.id,points:t}}))}_commitGesture(){"vertex"===this._gesture?.kind&&this._editingTarget&&this._liveEditPoints?this._dispatchVertexChanged(this._liveEditPoints):"pin"===this._gesture?.kind&&this._liveDragPin?(this.dispatchEvent(new CustomEvent("pin-move",{detail:{pinId:this._liveDragPin.id,x:this._liveDragPin.x,y:this._liveDragPin.y}})),this._liveDragPin=null):"openingMove"!==this._gesture?.kind&&"openingHandle"!==this._gesture?.kind||!this._liveOpeningEdit||(this.dispatchEvent(new CustomEvent("opening-update",{detail:{openingId:this._liveOpeningEdit.id,x:this._liveOpeningEdit.x,y:this._liveOpeningEdit.y,width:this._liveOpeningEdit.width}})),this._liveOpeningEdit=null)}_handleClick(t,e,i=!1){const n=this._clientToImage(t,e);if("trace"===this.mode){const t=this._pxToUnits(ne),e=this._pendingTrace??{points:[]},{point:[s,o]}=this._snappedGeometryPoint(e.points,n.x,n.y,i),l=Qt(e,s,o,t);return void(l.closed?(this.dispatchEvent(new CustomEvent("room-trace-complete",{detail:{points:e.points}})),this._pendingTrace=null):this._pendingTrace=l.trace)}if("wall"===this.mode){const t=this._pxToUnits(ne),e=this._pendingTrace??{points:[]},{point:[s,o]}=this._snappedGeometryPoint(e.points,n.x,n.y,i),l=Qt(e,s,o,t);return void(l.closed?(this.dispatchEvent(new CustomEvent("wall-trace-complete",{detail:{points:[...e.points,e.points[0]]}})),this._pendingTrace=null):this._pendingTrace=l.trace)}if("opening"===this.mode){if(!this.armedOpeningType)return;const t=this._pxToUnits(ne),e=Jt(this.walls,n.x,n.y,t);if(!e)return;const{point:i}=Ft(e.points,n.x,n.y);return void this.dispatchEvent(new CustomEvent("opening-place",{detail:{wallId:e.id,x:i[0],y:i[1]}}))}if("scale"===this.mode){const t=[...this._pendingScalePoints,[n.x,n.y]];return void(t.length>=2?(this.dispatchEvent(new CustomEvent("scale-line-complete",{detail:{points:t.slice(0,2)}})),this._pendingScalePoints=[]):this._pendingScalePoints=t)}if("place"===this.mode){if(this.armedEntityId){const t=this._pxToUnits(ne),e=Gt(this.pins,n.x,n.y,t)[0],i=e?.x??n.x,s=e?.y??n.y;this.dispatchEvent(new CustomEvent("pin-place",{detail:{x:i,y:s}}))}return}const s=this._downHit??{type:"empty"};if("vertex"===s.type)this._selectedVertexIndex=this._selectedVertexIndex===s.index?null:s.index;else if("edgeMidpoint"===s.type&&this._editingTarget&&this._liveEditPoints){const t=("room"===this._editingTarget.kind?Lt(this._liveEditPoints):At(this._liveEditPoints))[s.index],e=[...this._liveEditPoints];e.splice(s.index+1,0,t),this._liveEditPoints=e,this._dispatchVertexChanged(e)}else if("pin"===s.type)this.dispatchEvent(new CustomEvent("pin-select",{detail:{pinId:this.selectedPinId===s.pin.id?null:s.pin.id}}));else if("pinStack"===s.type)this.dispatchEvent(new CustomEvent("pin-stack-select",{detail:{pinIds:s.pins.map(t=>t.id)}}));else if("room"===s.type)this.dispatchEvent(new CustomEvent("room-select",{detail:{roomId:this.selectedRoomId===s.room.id?null:s.room.id}}));else if("wall"===s.type)this.dispatchEvent(new CustomEvent("wall-select",{detail:{wallId:this.selectedWallId===s.wall.id?null:s.wall.id}}));else if("opening"===s.type)this.dispatchEvent(new CustomEvent("opening-select",{detail:{openingId:this.selectedOpeningId===s.opening.id?null:s.opening.id}}));else if("meshLink"===s.type){const t=`${s.link.fromPin.id}|${s.link.toPin.id}`;this.dispatchEvent(new CustomEvent("mesh-link-select",{detail:{link:this.selectedMeshLinkKey===t?null:s.link}}))}else if("meshStub"===s.type){const t=`${s.stub.fromPin.id}|${s.stub.targetDeviceId}`;this.dispatchEvent(new CustomEvent("mesh-stub-select",{detail:{stub:this.selectedMeshStubKey===t?null:s.stub}}))}else if(this._editingTarget&&null!==this._selectedVertexIndex&&this._liveEditPoints){const t="room"===this._editingTarget.kind,[e,s]=this._snappedVertexPoint(this._liveEditPoints,this._selectedVertexIndex,n.x,n.y,t,i),o=[...this._liveEditPoints];o[this._selectedVertexIndex]=[e,s],this._liveEditPoints=o,this._selectedVertexIndex=null,this._dispatchVertexChanged(o)}else this._selectedVertexIndex=null,this.dispatchEvent(new CustomEvent("room-select",{detail:{roomId:null}})),this.dispatchEvent(new CustomEvent("pin-select",{detail:{pinId:null}})),this.dispatchEvent(new CustomEvent("wall-select",{detail:{wallId:null}})),this.dispatchEvent(new CustomEvent("opening-select",{detail:{openingId:null}})),this.dispatchEvent(new CustomEvent("mesh-link-select",{detail:{link:null}})),this.dispatchEvent(new CustomEvent("mesh-stub-select",{detail:{stub:null}}))}finishPendingWall(){"wall"!==this.mode||!this._pendingTrace||this._pendingTrace.points.length<2||(this.dispatchEvent(new CustomEvent("wall-trace-complete",{detail:{points:this._pendingTrace.points}})),this._pendingTrace=null)}cancelPending(){this._pendingTrace=null,this._pendingScalePoints=[]}_deleteSelectedVertex(){const t=this._editingTarget;if(null===this._selectedVertexIndex||!t||!this._liveEditPoints)return;const e="room"===t.kind?3:2;if(this._liveEditPoints.length<=e)return;const i=this._liveEditPoints.filter((t,e)=>e!==this._selectedVertexIndex);this._liveEditPoints=i,this._selectedVertexIndex=null,this._dispatchVertexChanged(i)}_zoomBy(t,e){const i=Ct(this._viewBox.w*t,250,4e3),n=i/this._viewBox.w,s=this._viewBox.h*n;this._viewBox={x:e.x-(e.x-this._viewBox.x)*n,y:e.y-(e.y-this._viewBox.y)*n,w:i,h:s}}_zoomButton(t){const e=this._viewBox;this._zoomBy(t,{x:e.x+e.w/2,y:e.y+e.h/2})}_pinLabel(t){return t.label_override?t.label_override:ft(t.device_id,this.entityLookup.values())}_renderRoom(t){if(!1===t.visible)return j;const e=this._effectivePoints("room",t.id,t.points);if(e.length<2)return j;const i=e.map(([t,e])=>`${t},${e}`).join(" "),[n,s]=function(t){if(0===t.length)return[0,0];let e=0,i=0;for(const[n,s]of t)e+=n,i+=s;return[e/t.length,i/t.length]}(e),o=this.editingRoomId===t.id,l=t.id===this.selectedRoomId||o,r=t.fill_color??se,a=t.fill_opacity??.18,c=t.border_opacity??1;return Y`
    ...
    `}_renderMeshStub(t){const e=`${t.fromPin.id}|${t.targetDeviceId}`===this.selectedMeshStubKey,i=this._pxToUnits(10);return Y`
      ...
      >
    `}_iconForOverride(t){return this._resolvedIconOverrides.has(t)?this._resolvedIconOverrides.get(t)??null:(this._resolvedIconOverrides.set(t,null),async function(t){const e=t.replace(/^mdi:/,"").trim();if(!e)return null;if(te.has(e))return te.get(e);try{const t=await fetch(`https://api.iconify.design/mdi/${e}.svg`);if(!t.ok)return te.set(e,null),null;const i=(await t.text()).match(/\sd="([^"]+)"/),n=i?i[1]:null;return te.set(e,n),n}catch{return te.set(e,null),null}}(t).then(e=>{null!==e&&(this._resolvedIconOverrides.set(t,e),this.requestUpdate())}),null)}_iconForPin(t){if(t.icon_override){const e=this._iconForOverride(t.icon_override);if(e)return{kind:"path",d:e}}const e=(i=t.device_id,n=this.entityLookup.values(),vt(i,n)?.integration_domain??null);var i,n;return e&&!this._failedBrandIcons.has(e)?{kind:"image",href:`https://brands.home-assistant.io/_/${e}/icon.png`,integrationDomain:e}:{kind:"path",d:"M3 6H21V4H3C1.9 4 1 4.9 1 6V18C1 19.1 1.9 20 3 20H7V18H3V6M13 12H9V13.78C8.39 14.33 8 15.11 8 16C8 16.89 8.39 17.67 9 18.22V20H13V18.22C13.61 17.67 14 16.88 14 16S13.61 14.33 13 13.78V12M11 17.5C10.17 17.5 9.5 16.83 9.5 16S10.17 14.5 11 14.5 12.5 15.17 12.5 16 11.83 17.5 11 17.5M22 8H16C15.5 8 15 8.5 15 9V19C15 19.5 15.5 20 16 20H22C22.5 20 23 19.5 23 19V9C23 8.5 22.5 8 22 8M21 18H17V10H21V18Z"}}_onBrandIconError(t){this._failedBrandIcons.has(t)||(this._failedBrandIcons=new Set(this._failedBrandIcons).add(t))}_pinGroups(){const t=new Map;for(const e of this.pins){const i=`${e.x},${e.y}`;t.has(i)||t.set(i,[]),t.get(i).push(e)}return[...t.values()].map(t=>({x:t[0].x,y:t[0].y,pins:t}))}_renderPinGroup(t){const e=this._pxToUnits(12);if(1===t.pins.length){const i=t.pins[0],n=this._liveDragPin?.id===i.id?this._liveDragPin:null,s=n?.x??i.x,o=n?.y??i.y,l=i.id===this.selectedPinId;return this._renderPinMarker(s,o,e,this._iconForPin(i),"var(--sc-accent)",l,this._pinLabel(i))}const i=t.pins.some(t=>t.id===this.selectedPinId),n=`${t.pins.length} devices: ${t.pins.map(t=>this._pinLabel(t)).join(", ")}`;return this._renderPinMarker(t.x,t.y,e,{kind:"path",d:"M12 16C13.1 16 14 16.9 14 18S13.1 20 12 20 10 19.1 10 18 10.9 16 12 16M12 10C13.1 10 14 10.9 14 12S13.1 14 12 14 10 13.1 10 12 10.9 10 12 10M12 4C13.1 4 14 4.9 14 6S13.1 8 12 8 10 7.1 10 6 10.9 4 12 4M6 16C7.1 16 8 16.9 8 18S7.1 20 6 20 4 19.1 4 18 4.9 16 6 16M6 10C7.1 10 8 10.9 8 12S7.1 14 6 14 4 13.1 4 12 4.9 10 6 10M6 4C7.1 4 8 4.9 8 6S7.1 8 6 8 4 7.1 4 6 4.9 4 6 4M18 16C19.1 16 20 16.9 20 18S19.1 20 18 20 16 19.1 16 18 16.9 16 18 16M18 10C19.1 10 20 10.9 20 12S19.1 14 18 14 16 13.1 16 12 16.9 10 18 10M18 4C19.1 4 20 4.9 20 6S19.1 8 18 8 16 7.1 16 6 16.9 4 18 4Z"},"var(--sc-accent)",i,n)}_renderPinMarker(t,e,i,n,s,o,l){const r=1.1*i;return Y`
      <g>
        <title>${l}</title>
        <circle
    ...
    `}_renderPendingTrace(){const t=this._pendingTrace?.points??[];if(0===t.length&&!this._hoverSnap)return j;const e=t.map(([t,e])=>`${t},${e}`).join(" "),i=this._pxToUnits(6),n=t[t.length-1],s=t[0],o=!!this._hoverSnap&&!!s&&t.length>=3&&Mt(this._hoverSnap.point[0],this._hoverSnap.point[1],s[0],s[1])<=this._pxToUnits(ne);return Y`
      ${t.length>0?Y`<polyline class="pending-trace" points=${e}></polyline>`:j}
      ${t.map(([t,e],n)=>Y`
          <circle
    ...
    `}_renderHoverSnap(t,e,i,n){if(!this._hoverSnap)return j;const[s,o]=this._hoverSnap.point,l=this._viewBox,r=i&&e?e:[s,o];return Y`
      ...
      ${i?j:Y`<circle
              ...
              r=${n}
            ></circle>`}
    `}_wallStrokeWidth(t,e){if(this.scale){const[[e,i],[n,s]]=this.scale.points,o=(Mt(e,i,n,s)||1)/this.scale.meters;return`${Ct($t(t)/100*o,.5,40)}`}return`${Ct(4+e.attenuationDbPerCm*$t(t)/3,4,8)}px`}_renderWall(t){const e=this._effectivePoints("wall",t.id,t.points),i=t.id===this.selectedWallId,n=this.editingWallId===t.id,s=xt(t.material),o=this._wallStrokeWidth(t,s),l=e[0],r=e[e.length-1],a=e.length>2&&!!l&&!!r&&l[0]===r[0]&&l[1]===r[1],c=(a?e.slice(0,-1):e).map(([t,e])=>`${t},${e}`).join(" "),d="wall-line "+(i||n?"selected":""),h=`stroke:${s.color}; stroke-width:${o}`;return Y`
      ${a?Y`<polygon class=${d} points=${c} style=${h}><title>${s.label}</title></polygon>`:Y`<polyline class=${d} points=${c} style=${h}><title>${s.label}</title></polyline>`}
      ${n?this._renderVertexHandles(e,!1):j}
    `}_renderOpening(t){const e=this._openingEndpoints(t);if(!e)return j;const[[i,n],[s,o]]=e,l=t.id===this.selectedOpeningId,r=this._pxToUnits(6),a=this.walls.find(e=>e.id===t.wallId),c=a?this._wallStrokeWidth(a,xt(a.material)):void 0,d=Mt(i,n,s,o)||1,h=parseFloat(c??"6")/2*1.5,p=-(o-n)/d*h,u=(s-i)/d*h,_=(t,e)=>Y`
      <line
    ...
    `;return Y`
      ...
      ${_(s,o)}
      ${l?Y`
            <circle class="opening-handle" cx=${i} cy=${n} r=${r}></circle>
            <circle class="opening-handle" cx=${s} cy=${o} r=${r}></circle>
          `:j}
    `}_renderScaleLine(){if(!this.scale)return j;const[[t,e],[i,n]]=this.scale.points;return Y`
      ...
      <text class="scale-label" x=${(t+i)/2} y=${(e+n)/2-6}>
        ${Nt(this.scale.meters,this.unitSystem)}
        ${Ht(this.unitSystem)}
      </text>
    `}_renderPendingScale(){if(0===this._pendingScalePoints.length)return j;const t=this._pxToUnits(6),[e,i]=this._pendingScalePoints[0];return Y`<circle class="vertex-handle" cx=${e} cy=${i} r=${t}></circle>`}_renderBackgroundOverlay(){if(!this.backgroundImageUrl)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.backgroundOffsetX-this._viewBox.x),s=i+t*(this.backgroundOffsetY-this._viewBox.y),o=t*this.backgroundScale;return V`
      ...
      >
        <img
          ...
          style="width:${ee}px; height:${this._naturalHeight}px; opacity:${this.backgroundOpacity};"
        />
      </div>
    `}_renderAlignOverlay(){if(!this.alignOverlay)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.alignOverlay.offsetX-this._viewBox.x),s=i+t*(this.alignOverlay.offsetY-this._viewBox.y),o=t*this.alignOverlay.scale;return V`
      ...
      >
        <img
          ...
          style="width:${ee}px; height:${this._alignNaturalHeight}px; opacity:${this.alignOverlay.opacity};"
        />
      </div>
    ...
    `],t([_t({attribute:!1})],oe.prototype,"rooms",void 0),t([_t({attribute:!1})],oe.prototype,"pins",void 0),t([_t({attribute:!1})],oe.prototype,"walls",void 0),t([_t({attribute:!1})],oe.prototype,"openings",void 0),t([_t({attribute:!1})],oe.prototype,"scale",void 0),t([_t({attribute:!1})],oe.prototype,"unitSystem",void 0),t([_t({attribute:!1})],oe.prototype,"meshLinks",void 0),t([_t({attribute:!1})],oe.prototype,"meshStubs",void 0),t([_t({attribute:!1})],oe.prototype,"entityLookup",void 0),t([_t({attribute:!1})],oe.prototype,"backgroundImageUrl",void 0),t([_t({type:Number})],oe.prototype,"backgroundOpacity",void 0),t([_t({type:Number})],oe.prototype,"backgroundOffsetX",void 0),t([_t({type:Number})],oe.prototype,"backgroundOffsetY",void 0),t([_t({type:Number})],oe.prototype,"backgroundScale",void 0),t([_t({attribute:!1})],oe.prototype,"alignOverlay",void 0),t([_t({attribute:!1})],oe.prototype,"initialViewBox",void 0),t([_t({type:Boolean})],oe.prototype,"sameBuildingAsPrevious",void 0),t([_t({attribute:!1})],oe.prototype,"mode",void 0),t([_t({attribute:!1})],oe.prototype,"armedEntityId",void 0),t([_t({attribute:!1})],oe.prototype,"armedOpeningType",void 0),t([_t({attribute:!1})],oe.prototype,"selectedRoomId",void 0),t([_t({attribute:!1})],oe.prototype,"editingRoomId",void 0),t([_t({attribute:!1})],oe.prototype,"editingWallId",void 0),t([_t({attribute:!1})],oe.prototype,"selectedPinId",void 0),t([_t({attribute:!1})],oe.prototype,"selectedWallId",void 0),t([_t({attribute:!1})],oe.prototype,"selectedOpeningId",void 0),t([_t({attribute:!1})],oe.prototype,"selectedMeshLinkKey",void 0),t([_t({attribute:!1})],oe.prototype,"selectedMeshStubKey",void 0),t([gt()],oe.prototype,"_viewBox",void 0),t([gt()],oe.prototype,"_naturalHeight",void 0),t([gt()],oe.prototype,"_alignNaturalHeight",void 0),t([gt()],oe.prototype,"_pendingTrace",void 0),t([gt()],oe.prototype,"_hoverSnap",void 0),t([gt()],oe.prototype,"_pendingScalePoints",void 0),t([gt()],oe.prototype,"_liveEditPoints",void 0),t([gt()],oe.prototype,"_liveDragPin",void 0),t([gt()],oe.prototype,"_liveOpeningEdit",void 0),t([gt()],oe.prototype,"_selectedVertexIndex",void 0),t([mt("svg")],oe.prototype,"_svg",void 0),t([gt()],oe.prototype,"_failedBrandIcons",void 0),oe=t([ht("floorplan-canvas")],oe);const le=[[-1,-1],[1,-1],[1,1],[-1,1]];let re=class extends ct{constructor(){super(...arguments),this.placements=[],this.floorNameById=new Map,this.floorIconById=new Map,this.backgroundImageUrl=null,this.backgroundOpacity=.85,this.backgroundOffsetX=0,this.backgroundOffsetY=0,this.backgroundScale=1,this.mode="select",this.selectedPlacementId=null,this.initialViewBox=null,this._viewBox={x:0,y:0,w:ee,h:750},this._naturalHeight=750,this._pointers=new Map,this._downHit=null,this._downClient=null,this._lastClient=null,this._gesture=null,this._moved=!1,this._hasFittedOnce=!1,this._onPointerDown=t=>{if("mouse"!==t.pointerType||0===t.button){if(this._svg.setPointerCapture(t.pointerId),this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n={x:(e.x+i.x)/2,y:(e.y+i.y)/2};return void(this._gesture={kind:"pinch",startDistance:Mt(e.x,e.y,i.x,i.y),startViewBox:{...this._viewBox},midImage:this._clientToImage(n.x,n.y)})}this._pointers.size>2||(this._downClient={x:t.clientX,y:t.clientY},this._lastClient={x:t.clientX,y:t.clientY},this._moved=!1,this._gesture=null,this._downHit="select"===this.mode?this._hitTest(t.clientX,t.clientY):{type:"empty"})}},this._onPointerMove=t=>{if(!this._pointers.has(t.pointerId))return;if(this._pointers.set(t.pointerId,{x:t.clientX,y:t.clientY}),"pinch"===this._gesture?.kind&&2===this._pointers.size){const t=[...this._pointers.values()],[e,i]=t,n=Mt(e.x,e.y,i.x,i.y)||1,s=this._gesture.startDistance/n,o=this._gesture.startViewBox,l=Ct(o.w*s,250,4e3),r=l/o.w,a=o.h*r,{x:c,y:d}=this._gesture.midImage;return void(this._viewBox={x:c-(c-o.x)*r,y:d-(d-o.y)*r,w:l,h:a})}if(1!==this._pointers.size||!this._downClient)return;if(!this._moved){if(Mt(this._downClient.x,this._downClient.y,t.clientX,t.clientY)<5)return;this._moved=!0,this._gesture=this._lockGesture(),"pan"===this._gesture?.kind&&(this._svg.style.cursor="grabbing")}const e=this._svgTransform().scale||1,i=this._lastClient??{x:t.clientX,y:t.clientY};if("pan"===this._gesture?.kind)this._viewBox={...this._viewBox,x:this._viewBox.x-(t.clientX-i.x)/e,y:this._viewBox.y-(t.clientY-i.y)/e};else if("move"===this._gesture?.kind)this._fire("placement-move",{id:this._gesture.id,dx:(t.clientX-i.x)/e,dy:(t.clientY-i.y)/e});else if("resize"===this._gesture?.kind){const e=this._gesture,i=this.placements.find(t=>t.id===e.id);if(i){const[n,s]=le[e.corner],o=-n,l=-s,r=this._clientToImage(t.clientX,t.clientY),a=i.rotation_deg*Math.PI/180,c=Math.cos(a),d=Math.sin(a),h=r.x-e.anchorWorld.x,p=r.y-e.anchorWorld.y,u=c*h+d*p,_=-d*h+c*p,g=Math.max(10,n*u),m=Math.max(10,s*_),y=i.aspect_ratio||g/m||1,v=Math.max(g,m*y),f=v/y,b=o*(v/2),x=l*(f/2);this._fire("placement-resize",{id:i.id,width:v,height:f,x:e.anchorWorld.x-(c*b-d*x),y:e.anchorWorld.y-(d*b+c*x)})}}else if("rotate"===this._gesture?.kind){const e=this._gesture.id,i=this.placements.find(t=>t.id===e);if(i){const e=this._clientToImage(t.clientX,t.clientY),n=((180*Math.atan2(e.y-i.y,e.x-i.x)/Math.PI+90)%360+360)%360;this._fire("placement-rotate",{id:i.id,rotationDeg:n})}}this._lastClient={x:t.clientX,y:t.clientY}},this._onPointerUp=t=>{this._pointers.delete(t.pointerId),this._svg.style.cursor="";try{this._svg.releasePointerCapture(t.pointerId)}catch{}this._pointers.size>=1?this._gesture=null:(!this._moved&&this._downClient&&this._handleClick(),this._gesture=null,this._downHit=null,this._downClient=null,this._moved=!1)},this._onWheel=t=>{if(t.preventDefault(),t.ctrlKey){const e=t.deltaY<0?.9:1.1;return void this._zoomBy(e,this._clientToImage(t.clientX,t.clientY))}const e=this._viewBox.w/this.getBoundingClientRect().width;this._viewBox={...this._viewBox,x:this._viewBox.x+t.deltaX*e,y:this._viewBox.y+t.deltaY*e}}}firstUpdated(){this.initialViewBox?(this._viewBox={...this.initialViewBox},this._hasFittedOnce=!0):(this.fitToScreen(),this._hasFittedOnce=this.placements.length>0||!this.backgroundImageUrl),this._resizeObserver=new ResizeObserver(()=>this.requestUpdate()),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect()}updated(t){if(t.has("backgroundImageUrl")&&this.backgroundImageUrl){const t=new Image;t.onload=()=>{this._naturalHeight=t.naturalHeight/t.naturalWidth*ee||750,this._hasFittedOnce||(this.fitToScreen(),this._hasFittedOnce=!0)},t.src=this.backgroundImageUrl}}_contentBounds(){if(0===this.placements.length)return null;const t=this.placements.flatMap(t=>[t.x-t.width,t.x+t.width]),e=this.placements.flatMap(t=>[t.y-t.height,t.y+t.height]),i=Math.min(...t),n=Math.max(...t),s=Math.min(...e),o=Math.max(...e),l=.15*Math.max(n-i,o-s)||60;return{x:i-l,y:s-l,w:n-i+2*l,h:o-s+2*l}}fitToScreen(){this._viewBox=this._contentBounds()??{x:0,y:0,w:ee,h:this._naturalHeight}}getViewBox(){return{...this._viewBox}}_svgTransform(){const t=this._svg?.getBoundingClientRect(),e=t?.width||this._viewBox.w,i=t?.height||this._viewBox.h,n=Math.min(e/this._viewBox.w,i/this._viewBox.h)||1;return{scale:n,offsetX:(e-this._viewBox.w*n)/2,offsetY:(i-this._viewBox.h*n)/2}}_pxToUnits(t){return t/this._svgTransform().scale}_clientToImage(t,e){const i=this._svg,n=i.createSVGPoint();n.x=t,n.y=e;const s=i.getScreenCTM();if(!s)return{x:0,y:0};const o=n.matrixTransform(s.inverse());return{x:o.x,y:o.y}}_toLocal(t,e,i){const n=t.rotation_deg*Math.PI/180,s=Math.cos(n),o=Math.sin(n),l=e-t.x,r=i-t.y;return{x:s*l+o*r,y:-o*l+s*r}}_localToWorld(t,e,i){const n=t.rotation_deg*Math.PI/180,s=Math.cos(n),o=Math.sin(n);return{x:t.x+s*e-o*i,y:t.y+o*e+s*i}}_hitTest(t,e){const i=this.placements.find(t=>t.id===this.selectedPlacementId);if(i){const n=this._pxToUnits(26),s=le.map(([t,e])=>[t*i.width/2,e*i.height/2]);for(let n=0;n<s.length;n++){const[o,l]=s[n],r=this._localToWorld(i,o,l),a=this._imageToClient(r.x,r.y);if(Mt(a.x,a.y,t,e)<=14)return{type:"resizeHandle",id:i.id,corner:n}}const o=this._localToWorld(i,0,-i.height/2-n),l=this._imageToClient(o.x,o.y);if(Mt(l.x,l.y,t,e)<=14)return{type:"rotateHandle",id:i.id}}const n=this._clientToImage(t,e);for(const t of[...this.placements].reverse()){const e=this._toLocal(t,n.x,n.y);if(Math.abs(e.x)<=t.width/2&&Math.abs(e.y)<=t.height/2)return{type:"body",id:t.id}}return{type:"empty"}}_imageToClient(t,e){const i=this._svg.getBoundingClientRect(),{scale:n,offsetX:s,offsetY:o}=this._svgTransform();return{x:i.left+s+(t-this._viewBox.x)*n,y:i.top+o+(e-this._viewBox.y)*n}}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_lockGesture(){if("resizeHandle"===this._downHit?.type){const t=this._downHit,e=this.placements.find(e=>e.id===t.id);if(!e)return{kind:"pan"};const[i,n]=le[t.corner],s=this._localToWorld(e,-i*e.width/2,-n*e.height/2);return{kind:"resize",id:e.id,corner:t.corner,anchorWorld:s}}return"rotateHandle"===this._downHit?.type?{kind:"rotate",id:this._downHit.id}:"body"===this._downHit?.type?{kind:"move",id:this._downHit.id}:{kind:"pan"}}_handleClick(){if("place"===this.mode){if(!this._downClient)return;const t=this._clientToImage(this._downClient.x,this._downClient.y);return void this._fire("placement-place",{x:t.x,y:t.y})}this._fire("placement-select",{id:"body"===this._downHit?.type?this._downHit.id:null})}_zoomBy(t,e){const i=Ct(this._viewBox.w*t,250,4e3),n=i/this._viewBox.w,s=this._viewBox.h*n;this._viewBox={x:e.x-(e.x-this._viewBox.x)*n,y:e.y-(e.y-this._viewBox.y)*n,w:i,h:s}}_zoomButton(t){const e=this._viewBox;this._zoomBy(t,{x:e.x+e.w/2,y:e.y+e.h/2})}_renderBackgroundOverlay(){if(!this.backgroundImageUrl)return j;const{scale:t,offsetX:e,offsetY:i}=this._svgTransform(),n=e+t*(this.backgroundOffsetX-this._viewBox.x),s=i+t*(this.backgroundOffsetY-this._viewBox.y),o=t*this.backgroundScale;return V`
      <div
        class="bg-overlay"
        style="transform: translate(${n}px, ${s}px) scale(${o});"
      >
    ...
    `],t([_t({attribute:!1})],re.prototype,"placements",void 0),t([_t({attribute:!1})],re.prototype,"floorNameById",void 0),t([_t({attribute:!1})],re.prototype,"floorIconById",void 0),t([_t({attribute:!1})],re.prototype,"backgroundImageUrl",void 0),t([_t({type:Number})],re.prototype,"backgroundOpacity",void 0),t([_t({type:Number})],re.prototype,"backgroundOffsetX",void 0),t([_t({type:Number})],re.prototype,"backgroundOffsetY",void 0),t([_t({type:Number})],re.prototype,"backgroundScale",void 0),t([_t({attribute:!1})],re.prototype,"mode",void 0),t([_t({attribute:!1})],re.prototype,"selectedPlacementId",void 0),t([_t({attribute:!1})],re.prototype,"initialViewBox",void 0),t([gt()],re.prototype,"_viewBox",void 0),t([gt()],re.prototype,"_naturalHeight",void 0),t([mt("svg")],re.prototype,"_svg",void 0),re=t([ht("property-canvas")],re);let ae=class extends ct{constructor(){super(...arguments),this.floors=[],this.selectedFloorId=null,this.propertySelected=!1}render(){return V`
      ${this.floors.map(t=>V`
          <button
    ...
    `],t([_t({attribute:!1})],ae.prototype,"floors",void 0),t([_t({attribute:!1})],ae.prototype,"selectedFloorId",void 0),t([_t({type:Boolean})],ae.prototype,"propertySelected",void 0),ae=t([ht("floor-tabs")],ae);let ce=class extends ct{constructor(){super(...arguments),this.floors=[],this.selectedFloorId=null,this.propertySelected=!1,this.dirty=!1,this.saving=!1}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}render(){return V`
      <div class="identity">
    ...
    `}_renderHintBar(){return"trace"===this.mode&&this.hasPendingTrace?V`<div class="hint-bar floating-panel">
      ...
      `}if(this.selectedWall){const t=this.selectedWall,e=this._wallThicknessUnit??Xt(this.unitSystem),i=this._thicknessInputAttrs(e);return V`
        <div class="selection-panel floating-panel">
          ...
          <input
            ...
            step=${i.step}
            .value=${jt($t(t),e)}
            @change=${t=>{const i=Kt(t.target.value,e);null===i||!Number.isFinite(i)||i<=0||this._fire("wall-thickness-change",{thicknessCm:i})}}
          />
      ...
      `}if(this.selectedOpening){const t=this.selectedOpening,e=this._openingWidthUnit??Xt(this.unitSystem),i=this._thicknessInputAttrs(e),n=this.unitsPerMeter;return V`
        <div class="selection-panel floating-panel">
          ...
          <input
            ...
            .value=${null!==n?function(t,e,i){return jt(t/e*100,i)}(t.width,n,e):String(t.width)}
            @change=${t=>{const i=t.target.value,s=null!==n?function(t,e,i){const n=Kt(t,i);return null===n?null:n/100*e}(i,n,e):Number(i);null===s||!Number.isFinite(s)||s<=0||this._fire("opening-width-change",{width:s})}}
          />
      ...
      `}return j}_pinLabel(t){return t.label_override?t.label_override:ft(t.device_id,this.entityLookup.values())}_renderPinStack(){return this.pinStack?V`
    ...
    `],t([_t({attribute:!1})],de.prototype,"mode",void 0),t([_t({attribute:!1})],de.prototype,"armedOpeningType",void 0),t([_t({type:Boolean})],de.prototype,"hasPendingTrace",void 0),t([_t({type:Boolean})],de.prototype,"hasPendingWall",void 0),t([_t({type:Number})],de.prototype,"pendingScaleCount",void 0),t([_t({attribute:!1})],de.prototype,"scaleReadout",void 0),t([_t({attribute:!1})],de.prototype,"selectedRoom",void 0),t([_t({type:Boolean})],de.prototype,"editingRoom",void 0),t([_t({attribute:!1})],de.prototype,"areas",void 0),t([_t({attribute:!1})],de.prototype,"selectedPin",void 0),t([_t({attribute:!1})],de.prototype,"selectedWall",void 0),t([_t({type:Boolean})],de.prototype,"editingWall",void 0),t([_t({attribute:!1})],de.prototype,"unitSystem",void 0),t([_t({type:Number})],de.prototype,"unitsPerMeter",void 0),t([_t({attribute:!1})],de.prototype,"pinStack",void 0),t([_t({attribute:!1})],de.prototype,"entityLookup",void 0),t([_t({attribute:!1})],de.prototype,"selectedOpening",void 0),t([_t({attribute:!1})],de.prototype,"selectedMeshLink",void 0),t([_t({attribute:!1})],de.prototype,"selectedMeshStub",void 0),t([_t({attribute:!1})],de.prototype,"otherFloors",void 0),t([_t({attribute:!1})],de.prototype,"alignTargetFloorId",void 0),t([_t({type:Boolean})],de.prototype,"alignTargetHasBackground",void 0),t([gt()],de.prototype,"_wallThicknessUnit",void 0),t([gt()],de.prototype,"_openingWidthUnit",void 0),de=t([ht("canvas-overlay")],de);let he=class extends ct{constructor(){super(...arguments),this.icon="",this.label="",this.open=!1}render(){return V`
      <button
    ...
    `],t([_t({attribute:!1})],pe.prototype,"entities",void 0),t([_t({attribute:!1})],pe.prototype,"placedDeviceIds",void 0),t([_t({attribute:!1})],pe.prototype,"armedEntityId",void 0),t([_t({attribute:!1})],pe.prototype,"floors",void 0),t([_t({attribute:!1})],pe.prototype,"areas",void 0),t([_t({attribute:!1})],pe.prototype,"currentFloorId",void 0),t([gt()],pe.prototype,"_search",void 0),t([gt()],pe.prototype,"_floorFilter",void 0),t([gt()],pe.prototype,"_areaFilter",void 0),pe=t([ht("entity-picker-sidebar")],pe);let ue=class extends ct{constructor(){super(...arguments),this.mode="select",this.buildings=[],this.armedBuildingKey=null,this.selectedPlacement=null,this.floorNameById=new Map}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_selectedLabel(){const t=this.selectedPlacement;return t?t.label_override||this.floorNameById.get(t.floor_id)||t.floor_id:""}render(){return V`
      <div class="mode-toolbar floating-panel">
        <button
    ...
    `],ge._ACCEPTED_BACKGROUND_TYPES=new Set(["image/png","image/jpeg","image/gif"]),t([gt()],ge.prototype,"_floors",void 0),t([gt()],ge.prototype,"_currentFloorId",void 0),t([gt()],ge.prototype,"_layout",void 0),t([gt()],ge.prototype,"_entities",void 0),t([gt()],ge.prototype,"_areas",void 0),t([gt()],ge.prototype,"_mode",void 0),t([gt()],ge.prototype,"_dragOverCanvas",void 0),t([gt()],ge.prototype,"_armedEntityId",void 0),t([gt()],ge.prototype,"_armedOpeningType",void 0),t([gt()],ge.prototype,"_selectedRoomId",void 0),t([gt()],ge.prototype,"_editingRoomId",void 0),t([gt()],ge.prototype,"_selectedPinId",void 0),t([gt()],ge.prototype,"_pinStackIds",void 0),t([gt()],ge.prototype,"_selectedWallId",void 0),t([gt()],ge.prototype,"_editingWallId",void 0),t([gt()],ge.prototype,"_selectedOpeningId",void 0),t([gt()],ge.prototype,"_selectedMeshLink",void 0),t([gt()],ge.prototype,"_selectedMeshStub",void 0),t([gt()],ge.prototype,"_otherFloorPinsByDeviceId",void 0),t([gt()],ge.prototype,"_dirty",void 0),t([gt()],ge.prototype,"_saving",void 0),t([gt()],ge.prototype,"_loading",void 0),t([gt()],ge.prototype,"_pendingCount",void 0),t([gt()],ge.prototype,"_networkType",void 0),t([gt()],ge.prototype,"_zigbeeMesh",void 0),t([gt()],ge.prototype,"_zigbeeMeshLoading",void 0),t([gt()],ge.prototype,"_zigbeeMeshError",void 0),t([gt()],ge.prototype,"_zigbeeMeshFetchedAt",void 0),t([gt()],ge.prototype,"_zigbeeMeshElapsedSeconds",void 0),t([gt()],ge.prototype,"_wifiMesh",void 0),t([gt()],ge.prototype,"_wifiMeshLoading",void 0),t([gt()],ge.prototype,"_wifiMeshError",void 0),t([gt()],ge.prototype,"_wifiMeshFetchedAt",void 0),t([gt()],ge.prototype,"_matterTopology",void 0),t([gt()],ge.prototype,"_matterError",void 0),t([gt()],ge.prototype,"_backgroundPopoverOpen",void 0),t([gt()],ge.prototype,"_meshPopoverOpen",void 0),t([gt()],ge.prototype,"_settings",void 0),t([gt()],ge.prototype,"_settingsPopoverOpen",void 0),t([gt()],ge.prototype,"_moreOptionsPopoverOpen",void 0),t([gt()],ge.prototype,"_view",void 0),t([gt()],ge.prototype,"_propertyLayout",void 0),t([gt()],ge.prototype,"_propertyDirty",void 0),t([gt()],ge.prototype,"_propertySaving",void 0),t([gt()],ge.prototype,"_selectedPlacementId",void 0),t([gt()],ge.prototype,"_propertyMode",void 0),t([gt()],ge.prototype,"_armedBuildingKey",void 0),t([gt()],ge.prototype,"_sameBuildingAsPreviousFloor",void 0),t([gt()],ge.prototype,"_alignTargetFloorId",void 0),t([gt()],ge.prototype,"_alignTargetLayout",void 0),t([gt()],ge.prototype,"_alignOffsetX",void 0),t([gt()],ge.prototype,"_alignOffsetY",void 0),t([gt()],ge.prototype,"_alignScale",void 0),t([mt("floorplan-canvas")],ge.prototype,"_canvas",void 0),t([mt("property-canvas")],ge.prototype,"_propertyCanvas",void 0),t([mt("#file-input")],ge.prototype,"_fileInput",void 0),ge=_e=t([ht("spatial-context-panel")],ge)}();
